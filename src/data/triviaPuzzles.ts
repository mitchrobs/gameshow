...
const CATEGORIES: TriviaCategory[] = [
  {
    ...
    questions: [
      ...
      {
        prompt: 'Machu Picchu sits in which mountain range?',
        options: ['Andes', 'Rockies', 'Alps', 'Himalayas'],
        answerIndex: 0,
        difficulty: 2,
      },
      {
        prompt: 'The Great Barrier Reef lies off the coast of which Australian state?',
        options: ['Queensland', 'New South Wales', 'Victoria', 'Western Australia'],
        answerIndex: 0,
        difficulty: 2,
      },
      {
      ...
      {
        prompt: 'The highest peak in Africa is in which country?',
