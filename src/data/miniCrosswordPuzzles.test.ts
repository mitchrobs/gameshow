...
describe('mini crossword dated schedule', () => {
  it('covers every date from launch through the rest of 2026', () => {
  ...
  it('enforces relaxed theme density and the November 3 Hope easter egg', () => {
    MINI_CROSSWORD_SCHEDULE.forEach((entry) => {
      expect(entry.quality.themeAnswerCount).toBeGreaterThanOrEqual(entry.size === 7 ? 5 : 1);
    });
