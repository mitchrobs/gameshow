...
import { CURATED_MIX_LAUNCH_EXPANSION } from './mixLaunchExpansion';
...
function applySportsHardOnlyTail(
  questions: CuratedTriviaSourceQuestion[]
): CuratedTriviaSourceQuestion[] {
  return questions.map((question) => {
    if (question.difficulty !== 3) return question;
    if (question.salienceScore <= 72) return question;
    return {
      ...question,
      salienceScore: 72,
    };
...
const SPORTS_TEAM_CARD_EXPANSION_SIX: TeamCard[] = [
  { team: 'Los Angeles Rams', city: 'Inglewood', venue: 'SoFi Stadium', league: 'NFL', sportLabel: 'football', subdomain: 'football', venueSalience: 88 },
  { team: 'Los Angeles Chargers', city: 'Inglewood', venue: 'SoFi Stadium', league: 'NFL', sportLabel: 'football', subdomain: 'football', venueSalience: 84 },
  { team: 'Minnesota Vikings', city: 'Minneapolis', venue: 'U.S. Bank Stadium', league: 'NFL', sportLabel: 'football', subdomain: 'football', venueSalience: 82 },
  { team: 'Tampa Bay Buccaneers', city: 'Tampa', venue: 'Raymond James Stadium', league: 'NFL', sportLabel: 'football', subdomain: 'football', venueSalience: 84 },
  { team: 'New Orleans Saints', city: 'New Orleans', venue: 'Caesars Superdome', league: 'NFL', sportLabel: 'football', subdomain: 'football', venueSalience: 86 },
  { team: 'Indianapolis Colts', city: 'Indianapolis', venue: 'Lucas Oil Stadium', league: 'NFL', sportLabel: 'football', subdomain: 'football', venueSalience: 84 },
  { team: 'Cleveland Browns', city: 'Cleveland', venue: 'Huntington Bank Field', league: 'NFL', sportLabel: 'football', subdomain: 'football', venueSalience: 80 },
  { team: 'Washington Commanders', city: 'Landover', venue: 'Northwest Stadium', league: 'NFL', sportLabel: 'football', subdomain: 'football', venueSalience: 78 },
  { team: 'Tennessee Titans', city: 'Nashville', venue: 'Nissan Stadium', league: 'NFL', sportLabel: 'football', subdomain: 'football', venueSalience: 80 },
];

const SPORTS_TEAM_CARD_EXPANSION_SEVEN: TeamCard[] = [
  { team: 'Detroit Lions', city: 'Detroit', venue: 'Ford Field', league: 'NFL', sportLabel: 'football', subdomain: 'football', venueSalience: 80 },
  { team: 'Jacksonville Jaguars', city: 'Jacksonville', venue: 'EverBank Stadium', league: 'NFL', sportLabel: 'football', subdomain: 'football', venueSalience: 72 },
  { team: 'New Orleans Pelicans', city: 'New Orleans', venue: 'Smoothie King Center', league: 'NBA', sportLabel: 'basketball', subdomain: 'basketball', venueSalience: 70 },
  { team: 'Minnesota Timberwolves', city: 'Minneapolis', venue: 'Target Center', league: 'NBA', sportLabel: 'basketball', subdomain: 'basketball', venueSalience: 74 },
  { team: 'Baltimore Orioles', city: 'Baltimore', venue: 'Oriole Park at Camden Yards', league: 'MLB', sportLabel: 'baseball', subdomain: 'baseball', venueSalience: 88 },
  { team: 'Philadelphia Flyers', city: 'Philadelphia', venue: 'Wells Fargo Center', league: 'NHL', sportLabel: 'hockey', subdomain: 'hockey', venueSalience: 76 },
];
...
const SPORTS_PLAYER_CARD_EXPANSION_TWELVE: PlayerCard[] = [
  { name: 'Xander Schauffele', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Xander Schauffele is best known for competing in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Tennis', 'Baseball'], salience: 86 },
  { name: 'Nick Faldo', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Nick Faldo rose to fame in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Cricket', 'Tennis'], salience: 86 },
  { name: 'Bernhard Langer', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Bernhard Langer is best known for competing in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Tennis', 'Biathlon'], salience: 84 },
  { name: 'Lexi Thompson', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Lexi Thompson is most closely associated with which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Tennis', 'Gymnastics'], salience: 84 },
  { name: 'Nancy Lopez', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Nancy Lopez became famous in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Figure skating', 'Tennis'], salience: 84 },
  { name: 'Daniil Medvedev', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Daniil Medvedev is best known for competing in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Cycling', 'Soccer'], salience: 86 },
  { name: 'Ons Jabeur', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Ons Jabeur rose to fame in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Fencing', 'Golf'], salience: 85 },
  { name: 'Elena Rybakina', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Elena Rybakina is best known for competing in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Gymnastics', 'Golf'], salience: 84 },
  { name: 'Garbine Muguruza', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Garbine Muguruza became famous in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Figure skating', 'Golf'], salience: 84 },
  { name: 'Bianca Andreescu', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Bianca Andreescu is best known for competing in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Speed skating', 'Soccer'], salience: 84 },
  { name: 'Mark Spitz', subdomain: 'olympics', sportLabel: 'swimming', achievementPrompt: 'Mark Spitz is most closely associated with which Olympic sport?', achievementAnswer: 'Swimming', achievementOptions: ['Swimming', 'Rowing', 'Diving'], salience: 88 },
  { name: 'Jackie Joyner-Kersee', subdomain: 'olympics', sportLabel: 'track and field', achievementPrompt: 'Jackie Joyner-Kersee became famous in the Olympics in which sport family?', achievementAnswer: 'Track and field', achievementOptions: ['Track and field', 'Swimming', 'Cycling'], salience: 87 },
  { name: 'Shawn Johnson', subdomain: 'olympics', sportLabel: 'gymnastics', achievementPrompt: 'Shawn Johnson is most closely associated with which Olympic sport?', achievementAnswer: 'Gymnastics', achievementOptions: ['Gymnastics', 'Diving', 'Figure skating'], salience: 85 },
  { name: 'Ryan Lochte', subdomain: 'olympics', sportLabel: 'swimming', achievementPrompt: 'Ryan Lochte is most closely associated with which Olympic sport?', achievementAnswer: 'Swimming', achievementOptions: ['Swimming', 'Rowing', 'Cycling'], salience: 84 },
  { name: 'Sebastian Vettel', subdomain: 'motorsport', sportLabel: 'motorsport', achievementPrompt: 'Sebastian Vettel rose to fame in which sport?', achievementAnswer: 'Motorsport', achievementOptions: ['Motorsport', 'Cycling', 'Tennis'], salience: 88 },
  { name: 'Alain Prost', subdomain: 'motorsport', sportLabel: 'motorsport', achievementPrompt: 'Alain Prost is best known for competing in which sport?', achievementAnswer: 'Motorsport', achievementOptions: ['Motorsport', 'Horse racing', 'Soccer'], salience: 86 },
  { name: 'Kimi Raikkonen', subdomain: 'motorsport', sportLabel: 'motorsport', nickname: 'The Iceman', achievementPrompt: 'Kimi Raikkonen is best known for competing in which sport?', achievementAnswer: 'Motorsport', achievementOptions: ['Motorsport', 'Cycling', 'Tennis'], salience: 86 },
  { name: 'Israel Adesanya', subdomain: 'combat', sportLabel: 'mma', achievementPrompt: 'Israel Adesanya is best known for competing in which combat sport?', achievementAnswer: 'MMA', achievementOptions: ['MMA', 'Boxing', 'Judo'], salience: 85 },
  { name: 'Oleksandr Usyk', subdomain: 'combat', sportLabel: 'boxing', achievementPrompt: 'Oleksandr Usyk is best known for competing in which sport?', achievementAnswer: 'Boxing', achievementOptions: ['Boxing', 'MMA', 'Wrestling'], salience: 85 },
  { name: 'Gervonta Davis', subdomain: 'combat', sportLabel: 'boxing', achievementPrompt: 'Gervonta Davis rose to fame in which sport?', achievementAnswer: 'Boxing', achievementOptions: ['Boxing', 'MMA', 'Karate'], salience: 84 },
];

const SPORTS_PLAYER_CARD_EXPANSION_THIRTEEN: PlayerCard[] = [
  { name: 'Padraig Harrington', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Padraig Harrington is best known for competing in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Cricket', 'Tennis'], salience: 84 },
  { name: 'Nick Price', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Nick Price rose to fame in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Cycling', 'Baseball'], salience: 83 },
  { name: 'Caroline Wozniacki', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Caroline Wozniacki is best known for competing in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Figure skating', 'Golf'], salience: 84 },
  { name: 'Stan Wawrinka', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Stan Wawrinka rose to fame in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Cycling', 'Soccer'], salience: 84 },
  { name: 'Misty May-Treanor', subdomain: 'olympics', sportLabel: 'beach volleyball', achievementPrompt: 'Misty May-Treanor is most closely associated with which Olympic sport?', achievementAnswer: 'Beach volleyball', achievementOptions: ['Beach volleyball', 'Indoor gymnastics', 'Diving'], salience: 83 },
  { name: 'Nigel Mansell', subdomain: 'motorsport', sportLabel: 'motorsport', achievementPrompt: 'Nigel Mansell is best known for competing in which sport?', achievementAnswer: 'Motorsport', achievementOptions: ['Motorsport', 'Cycling', 'Soccer'], salience: 84 },
  { name: 'Katie Taylor', subdomain: 'combat', sportLabel: 'boxing', achievementPrompt: 'Katie Taylor is best known for competing in which sport?', achievementAnswer: 'Boxing', achievementOptions: ['Boxing', 'MMA', 'Fencing'], salience: 83 },
  { name: 'Terence Crawford', subdomain: 'combat', sportLabel: 'boxing', achievementPrompt: 'Terence Crawford rose to fame in which sport?', achievementAnswer: 'Boxing', achievementOptions: ['Boxing', 'MMA', 'Wrestling'], salience: 83 },
];

const SPORTS_PLAYER_CARD_EXPANSION_FOURTEEN: PlayerCard[] = [
  { name: 'Sergio Garcia', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Sergio Garcia is best known for competing in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Tennis', 'Soccer'], salience: 84 },
  { name: 'Tom Kite', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Tom Kite rose to fame in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Baseball', 'Tennis'], salience: 82 },
  { name: 'Casper Ruud', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Casper Ruud is best known for competing in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Cycling', 'Soccer'], salience: 83 },
  { name: 'Jelena Ostapenko', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Jelena Ostapenko rose to fame in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Figure skating', 'Golf'], salience: 82 },
  { name: 'Lindsey Vonn', subdomain: 'olympics', sportLabel: 'skiing', achievementPrompt: 'Lindsey Vonn is most closely associated with which Olympic sport?', achievementAnswer: 'Skiing', achievementOptions: ['Skiing', 'Snowboarding', 'Curling'], salience: 86 },
  { name: 'Nico Rosberg', subdomain: 'motorsport', sportLabel: 'motorsport', achievementPrompt: 'Nico Rosberg is best known for competing in which sport?', achievementAnswer: 'Motorsport', achievementOptions: ['Motorsport', 'Cycling', 'Tennis'], salience: 83 },
];

const SPORTS_PLAYER_CARD_EXPANSION_FIFTEEN: PlayerCard[] = [
  { name: 'Brett Favre', subdomain: 'football', sportLabel: 'football', team: 'Green Bay Packers', position: 'quarterback', achievementPrompt: 'Brett Favre won his three straight NFL MVP awards primarily with which franchise?', achievementAnswer: 'Green Bay Packers', achievementOptions: ['Green Bay Packers', 'Minnesota Vikings', 'Atlanta Falcons'], salience: 92 },
  { name: 'Dan Marino', subdomain: 'football', sportLabel: 'football', team: 'Miami Dolphins', position: 'quarterback', salience: 90 },
  { name: 'John Elway', subdomain: 'football', sportLabel: 'football', team: 'Denver Broncos', position: 'quarterback', salience: 91 },
  { name: 'Steve Young', subdomain: 'football', sportLabel: 'football', team: 'San Francisco 49ers', position: 'quarterback', salience: 89 },
  { name: 'Jim Brown', subdomain: 'football', sportLabel: 'football', team: 'Cleveland Browns', position: 'running back', salience: 91 },
  { name: 'Randy Moss', subdomain: 'football', sportLabel: 'football', team: 'Minnesota Vikings', position: 'wide receiver', salience: 88 },
  { name: 'Reggie White', subdomain: 'football', sportLabel: 'football', team: 'Green Bay Packers', position: 'defensive end', nickname: 'The Minister of Defense', salience: 88 },
  { name: 'Ray Lewis', subdomain: 'football', sportLabel: 'football', team: 'Baltimore Ravens', position: 'linebacker', salience: 89 },
  { name: 'Troy Polamalu', subdomain: 'football', sportLabel: 'football', team: 'Pittsburgh Steelers', position: 'safety', salience: 86 },
  { name: 'Rob Gronkowski', subdomain: 'football', sportLabel: 'football', team: 'New England Patriots', position: 'tight end', nickname: 'Gronk', salience: 88 },
  { name: 'Marshawn Lynch', subdomain: 'football', sportLabel: 'football', team: 'Seattle Seahawks', position: 'running back', nickname: 'Beast Mode', salience: 87 },
  { name: 'Terrell Owens', subdomain: 'football', sportLabel: 'football', team: 'San Francisco 49ers', position: 'wide receiver', nickname: 'T.O.', salience: 86 },
];

const SPORTS_PLAYER_CARD_EXPANSION_SIXTEEN: PlayerCard[] = [
  { name: 'Magic Johnson', subdomain: 'basketball', sportLabel: 'basketball', team: 'Los Angeles Lakers', position: 'point guard', nickname: 'Magic', salience: 95 },
  { name: 'Larry Bird', subdomain: 'basketball', sportLabel: 'basketball', team: 'Boston Celtics', position: 'forward', salience: 93 },
  { name: 'Tim Duncan', subdomain: 'basketball', sportLabel: 'basketball', team: 'San Antonio Spurs', position: 'power forward', nickname: 'The Big Fundamental', salience: 91 },
  { name: 'Dwyane Wade', subdomain: 'basketball', sportLabel: 'basketball', team: 'Miami Heat', position: 'shooting guard', nickname: 'Flash', salience: 90 },
  { name: 'Allen Iverson', subdomain: 'basketball', sportLabel: 'basketball', team: 'Philadelphia 76ers', position: 'point guard', nickname: 'The Answer', salience: 89 },
  { name: 'Dirk Nowitzki', subdomain: 'basketball', sportLabel: 'basketball', team: 'Dallas Mavericks', position: 'power forward', salience: 90 },
  { name: 'Derek Jeter', subdomain: 'baseball', sportLabel: 'baseball', team: 'New York Yankees', position: 'shortstop', salience: 92 },
  { name: 'Ken Griffey Jr.', subdomain: 'baseball', sportLabel: 'baseball', team: 'Seattle Mariners', position: 'center fielder', nickname: 'The Kid', salience: 92 },
  { name: 'David Ortiz', subdomain: 'baseball', sportLabel: 'baseball', team: 'Boston Red Sox', position: 'designated hitter', nickname: 'Big Papi', salience: 90 },
  { name: 'Mariano Rivera', subdomain: 'baseball', sportLabel: 'baseball', team: 'New York Yankees', position: 'closer', salience: 90 },
  { name: 'Pedro Martinez', subdomain: 'baseball', sportLabel: 'baseball', team: 'Boston Red Sox', position: 'pitcher', salience: 89 },
  { name: 'Wayne Gretzky', subdomain: 'hockey', sportLabel: 'hockey', team: 'Edmonton Oilers', position: 'center', nickname: 'The Great One', salience: 97 },
  { name: 'Patrick Roy', subdomain: 'hockey', sportLabel: 'hockey', team: 'Montreal Canadiens', position: 'goaltender', salience: 90 },
  { name: 'Mario Lemieux', subdomain: 'hockey', sportLabel: 'hockey', team: 'Pittsburgh Penguins', position: 'center', nickname: 'Super Mario', salience: 92 },
  { name: 'Jaromir Jagr', subdomain: 'hockey', sportLabel: 'hockey', team: 'Pittsburgh Penguins', position: 'right wing', salience: 88 },
];

const SPORTS_PLAYER_CARD_EXPANSION_SEVENTEEN: PlayerCard[] = [
  { name: 'Dak Prescott', subdomain: 'football', sportLabel: 'football', team: 'Dallas Cowboys', position: 'quarterback', salience: 90 },
  { name: 'Tua Tagovailoa', subdomain: 'football', sportLabel: 'football', team: 'Miami Dolphins', position: 'quarterback', salience: 88 },
  { name: 'Christian McCaffrey', subdomain: 'football', sportLabel: 'football', team: 'San Francisco 49ers', position: 'running back', salience: 90 },
  { name: 'George Kittle', subdomain: 'football', sportLabel: 'football', team: 'San Francisco 49ers', position: 'tight end', salience: 88 },
  { name: 'Stefon Diggs', subdomain: 'football', sportLabel: 'football', team: 'Buffalo Bills', position: 'wide receiver', salience: 88 },
  { name: 'Davante Adams', subdomain: 'football', sportLabel: 'football', team: 'Las Vegas Raiders', position: 'wide receiver', salience: 89 },
  { name: 'T.J. Watt', subdomain: 'football', sportLabel: 'football', team: 'Pittsburgh Steelers', position: 'linebacker', salience: 88 },
  { name: 'Jared Goff', subdomain: 'football', sportLabel: 'football', team: 'Detroit Lions', position: 'quarterback', salience: 88 },
  { name: 'Baker Mayfield', subdomain: 'football', sportLabel: 'football', team: 'Tampa Bay Buccaneers', position: 'quarterback', salience: 87 },
  { name: 'Cooper Kupp', subdomain: 'football', sportLabel: 'football', team: 'Los Angeles Rams', position: 'wide receiver', salience: 88 },
  { name: 'Jason Kelce', subdomain: 'football', sportLabel: 'football', team: 'Philadelphia Eagles', position: 'center', salience: 89 },
  { name: 'Cam Newton', subdomain: 'football', sportLabel: 'football', team: 'Carolina Panthers', position: 'quarterback', nickname: 'Super Cam', salience: 89 },
  { name: 'Russell Wilson', subdomain: 'football', sportLabel: 'football', team: 'Seattle Seahawks', position: 'quarterback', salience: 89 },
  { name: 'Julio Jones', subdomain: 'football', sportLabel: 'football', team: 'Atlanta Falcons', position: 'wide receiver', salience: 88 },
  { name: 'Antonio Brown', subdomain: 'football', sportLabel: 'football', team: 'Pittsburgh Steelers', position: 'wide receiver', salience: 87 },
  { name: 'Jaylen Brown', subdomain: 'basketball', sportLabel: 'basketball', team: 'Boston Celtics', position: 'guard', salience: 89 },
  { name: 'Tyrese Haliburton', subdomain: 'basketball', sportLabel: 'basketball', team: 'Indiana Pacers', position: 'guard', salience: 88 },
  { name: 'Victor Wembanyama', subdomain: 'basketball', sportLabel: 'basketball', team: 'San Antonio Spurs', position: 'center', nickname: 'Wemby', salience: 90 },
  { name: 'Paul George', subdomain: 'basketball', sportLabel: 'basketball', team: 'Los Angeles Clippers', position: 'forward', salience: 89 },
  { name: "De'Aaron Fox", subdomain: 'basketball', sportLabel: 'basketball', team: 'Sacramento Kings', position: 'guard', salience: 87 },
  { name: 'Trae Young', subdomain: 'basketball', sportLabel: 'basketball', team: 'Atlanta Hawks', position: 'guard', salience: 88 },
  { name: 'Paolo Banchero', subdomain: 'basketball', sportLabel: 'basketball', team: 'Orlando Magic', position: 'forward', salience: 86 },
  { name: 'Karl-Anthony Towns', subdomain: 'basketball', sportLabel: 'basketball', team: 'Minnesota Timberwolves', position: 'center', salience: 88 },
  { name: 'Jimmy Butler', subdomain: 'basketball', sportLabel: 'basketball', team: 'Miami Heat', position: 'forward', salience: 89 },
  { name: 'Domantas Sabonis', subdomain: 'basketball', sportLabel: 'basketball', team: 'Sacramento Kings', position: 'center', salience: 86 },
  { name: 'Ja Morant', subdomain: 'basketball', sportLabel: 'basketball', team: 'Memphis Grizzlies', position: 'guard', salience: 89 },
  { name: 'Zion Williamson', subdomain: 'basketball', sportLabel: 'basketball', team: 'New Orleans Pelicans', position: 'forward', salience: 88 },
  { name: 'Juan Soto', subdomain: 'baseball', sportLabel: 'baseball', team: 'New York Yankees', position: 'outfielder', salience: 90 },
  { name: 'Fernando Tatis Jr.', subdomain: 'baseball', sportLabel: 'baseball', team: 'San Diego Padres', position: 'right fielder', salience: 89 },
  { name: 'Ronald Acuna Jr.', subdomain: 'baseball', sportLabel: 'baseball', team: 'Atlanta Braves', position: 'outfielder', salience: 89 },
  { name: 'Nolan Arenado', subdomain: 'baseball', sportLabel: 'baseball', team: 'St. Louis Cardinals', position: 'third baseman', salience: 88 },
  { name: 'Max Scherzer', subdomain: 'baseball', sportLabel: 'baseball', team: 'Texas Rangers', position: 'pitcher', salience: 88 },
  { name: 'Justin Verlander', subdomain: 'baseball', sportLabel: 'baseball', team: 'Houston Astros', position: 'pitcher', salience: 89 },
  { name: 'Vladimir Guerrero Jr.', subdomain: 'baseball', sportLabel: 'baseball', team: 'Toronto Blue Jays', position: 'first baseman', salience: 88 },
  { name: 'Adley Rutschman', subdomain: 'baseball', sportLabel: 'baseball', team: 'Baltimore Orioles', position: 'catcher', salience: 86 },
  { name: 'Julio Rodriguez', subdomain: 'baseball', sportLabel: 'baseball', team: 'Seattle Mariners', position: 'center fielder', salience: 87 },
  { name: 'Pete Alonso', subdomain: 'baseball', sportLabel: 'baseball', team: 'New York Mets', position: 'first baseman', nickname: 'Polar Bear', salience: 87 },
  { name: 'Nikita Kucherov', subdomain: 'hockey', sportLabel: 'hockey', team: 'Tampa Bay Lightning', position: 'right wing', salience: 89 },
  { name: 'Steven Stamkos', subdomain: 'hockey', sportLabel: 'hockey', team: 'Tampa Bay Lightning', position: 'center', salience: 88 },
  { name: 'Victor Hedman', subdomain: 'hockey', sportLabel: 'hockey', team: 'Tampa Bay Lightning', position: 'defenseman', salience: 87 },
  { name: 'Patrice Bergeron', subdomain: 'hockey', sportLabel: 'hockey', team: 'Boston Bruins', position: 'center', salience: 88 },
  { name: 'David Pastrnak', subdomain: 'hockey', sportLabel: 'hockey', team: 'Boston Bruins', position: 'right wing', salience: 88 },
  { name: 'Mikko Rantanen', subdomain: 'hockey', sportLabel: 'hockey', team: 'Colorado Avalanche', position: 'right wing', salience: 87 },
  { name: 'Andrei Vasilevskiy', subdomain: 'hockey', sportLabel: 'hockey', team: 'Tampa Bay Lightning', position: 'goaltender', salience: 87 },
  { name: 'Roman Josi', subdomain: 'hockey', sportLabel: 'hockey', team: 'Nashville Predators', position: 'defenseman', salience: 86 },
  { name: 'John Tavares', subdomain: 'hockey', sportLabel: 'hockey', team: 'Toronto Maple Leafs', position: 'center', salience: 86 },
  { name: 'Quinn Hughes', subdomain: 'hockey', sportLabel: 'hockey', team: 'Vancouver Canucks', position: 'defenseman', salience: 86 },
  { name: 'Kirill Kaprizov', subdomain: 'hockey', sportLabel: 'hockey', team: 'Minnesota Wild', position: 'left wing', salience: 86 },
  { name: 'Anze Kopitar', subdomain: 'hockey', sportLabel: 'hockey', team: 'Los Angeles Kings', position: 'center', salience: 86 },
];

const SPORTS_PLAYER_CARD_EXPANSION_EIGHTEEN: PlayerCard[] = [
  { name: 'Justin Rose', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Justin Rose is best known for competing in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Tennis', 'Cricket'], salience: 86 },
  { name: 'Viktor Hovland', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Viktor Hovland is best known for competing in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Tennis', 'Skiing'], salience: 85 },
  { name: 'Hideki Matsuyama', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Hideki Matsuyama is best known for competing in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Baseball', 'Tennis'], salience: 87 },
  { name: 'Fred Couples', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Fred Couples rose to fame in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Tennis', 'Baseball'], salience: 85 },
  { name: 'Lee Trevino', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Lee Trevino is best known for competing in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Baseball', 'Auto racing'], salience: 86 },
  { name: 'Jim Furyk', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Jim Furyk is best known for competing in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Tennis', 'Baseball'], salience: 84 },
  { name: 'Bubba Watson', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Bubba Watson is best known for competing in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Baseball', 'Motorsport'], salience: 85 },
  { name: 'Jason Day', subdomain: 'golf', sportLabel: 'golf', achievementPrompt: 'Jason Day rose to fame in which sport?', achievementAnswer: 'Golf', achievementOptions: ['Golf', 'Tennis', 'Cricket'], salience: 84 },
  { name: 'Martina Hingis', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Martina Hingis is best known for competing in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Figure skating', 'Golf'], salience: 86 },
  { name: 'Bjorn Borg', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Bjorn Borg rose to fame in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Soccer', 'Cycling'], salience: 88 },
  { name: 'Jimmy Connors', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Jimmy Connors is best known for competing in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Baseball', 'Golf'], salience: 87 },
  { name: 'Boris Becker', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Boris Becker became famous in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Soccer', 'Cycling'], salience: 86 },
  { name: 'Lindsay Davenport', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Lindsay Davenport is best known for competing in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Golf', 'Figure skating'], salience: 85 },
  { name: 'John McEnroe', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'John McEnroe rose to fame in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Baseball', 'Boxing'], salience: 89 },
  { name: 'Lleyton Hewitt', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Lleyton Hewitt is best known for competing in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Cricket', 'Soccer'], salience: 84 },
  { name: 'Patrick Rafter', subdomain: 'tennis', sportLabel: 'tennis', achievementPrompt: 'Patrick Rafter became famous in which sport?', achievementAnswer: 'Tennis', achievementOptions: ['Tennis', 'Cycling', 'Soccer'], salience: 84 },
  { name: 'Nastia Liukin', subdomain: 'olympics', sportLabel: 'gymnastics', achievementPrompt: 'Nastia Liukin is most closely associated with which Olympic sport?', achievementAnswer: 'Gymnastics', achievementOptions: ['Gymnastics', 'Swimming', 'Diving'], salience: 86 },
  { name: 'Apollo Ohno', subdomain: 'olympics', sportLabel: 'speed skating', achievementPrompt: 'Apollo Ohno is most closely associated with which Olympic sport?', achievementAnswer: 'Speed skating', achievementOptions: ['Speed skating', 'Skiing', 'Snowboarding'], salience: 88 },
  { name: 'Bonnie Blair', subdomain: 'olympics', sportLabel: 'speed skating', achievementPrompt: 'Bonnie Blair became famous in which Olympic sport?', achievementAnswer: 'Speed skating', achievementOptions: ['Speed skating', 'Gymnastics', 'Swimming'], salience: 85 },
  { name: 'Kerri Strug', subdomain: 'olympics', sportLabel: 'gymnastics', achievementPrompt: 'Kerri Strug is most closely associated with which Olympic sport?', achievementAnswer: 'Gymnastics', achievementOptions: ['Gymnastics', 'Diving', 'Track and field'], salience: 85 },
  { name: 'McKayla Maroney', subdomain: 'olympics', sportLabel: 'gymnastics', achievementPrompt: 'McKayla Maroney became famous in which Olympic sport?', achievementAnswer: 'Gymnastics', achievementOptions: ['Gymnastics', 'Swimming', 'Figure skating'], salience: 84 },
  { name: 'Missy Franklin', subdomain: 'olympics', sportLabel: 'swimming', achievementPrompt: 'Missy Franklin is most closely associated with which Olympic sport?', achievementAnswer: 'Swimming', achievementOptions: ['Swimming', 'Rowing', 'Cycling'], salience: 84 },
  { name: 'Gabby Thomas', subdomain: 'olympics', sportLabel: 'track and field', achievementPrompt: 'Gabby Thomas is most closely associated with which Olympic sport family?', achievementAnswer: 'Track and field', achievementOptions: ['Track and field', 'Swimming', 'Gymnastics'], salience: 84 },
  { name: 'Ashton Eaton', subdomain: 'olympics', sportLabel: 'track and field', achievementPrompt: 'Ashton Eaton became famous in the Olympics in which sport family?', achievementAnswer: 'Track and field', achievementOptions: ['Track and field', 'Cycling', 'Swimming'], salience: 84 },
];
...
const ALL_SPORTS_TEAM_CARDS = [
  ...
  ...SPORTS_TEAM_CARD_EXPANSION_SIX,
  ...SPORTS_TEAM_CARD_EXPANSION_SEVEN,
];
const ALL_SPORTS_PLAYER_CARDS = [
  ...
  ...SPORTS_PLAYER_CARD_EXPANSION_TWELVE,
  ...SPORTS_PLAYER_CARD_EXPANSION_THIRTEEN,
  ...SPORTS_PLAYER_CARD_EXPANSION_FOURTEEN,
  ...SPORTS_PLAYER_CARD_EXPANSION_FIFTEEN,
  ...SPORTS_PLAYER_CARD_EXPANSION_SIXTEEN,
  ...SPORTS_PLAYER_CARD_EXPANSION_SEVENTEEN,
  ...SPORTS_PLAYER_CARD_EXPANSION_EIGHTEEN,
];
...
const CURATED_SPORTS_CORE: CuratedTriviaSourceQuestion[] = [
  ...
  q({ prompt: 'What is pole position in racing?', options: ['The front-most starting spot', 'The final-place qualifying slot', 'A pit lane restart'], answerIndex: 0, difficulty: 1, subdomain: 'motorsport', promptKind: 'term', salienceScore: 89, lookupRisk: 'low', rationaleShort: 'Pole position is the front-most starting spot.', rationaleLong: 'The fastest qualifier starts first on the grid, which is known as pole position.', isTrickQuestion: false }),
...
const CURATED_SPORTS_CANONICAL_EXPANSION: CuratedTriviaSourceQuestion[] = [
  ...
  q({ prompt: 'In football, what is a strip sack?', options: ['A sack that forces a fumble', 'A sack made before the snap count ends', 'A sack that wipes out a touchdown'], answerIndex: 0, difficulty: 2, subdomain: 'football', promptKind: 'term', salienceScore: 84, lookupRisk: 'low', rationaleShort: 'A strip sack is a sack that jars the ball loose.', rationaleLong: 'A strip sack happens when a defender sacks the quarterback and forces a fumble on the same play.', citations: searchCitation('Strip sack', 'strip sack football') }),
  ...
  q({ prompt: 'What is a walk-off in baseball?', options: ['A game-ending hit or play by the home team', 'A deliberate intentional walk with the bases loaded', 'A pitcher leaving the mound during a live at-bat'], answerIndex: 0, difficulty: 2, subdomain: 'baseball', promptKind: 'term', salienceScore: 86, lookupRisk: 'low', rationaleShort: 'A walk-off ends the game for the home team.', rationaleLong: 'A walk-off refers to the play that immediately ends the game in favor of the home team, usually on a hit or home run.', citations: searchCitation('Walk-off baseball', 'walk-off baseball') }),
  ...
  q({ prompt: 'In hockey, what is the five-hole?', options: ['The gap between a goalie’s legs', 'The bench area where extra sticks are stored', 'The zone between the blue lines and the boards'], answerIndex: 0, difficulty: 3, subdomain: 'hockey', promptKind: 'term', salienceScore: 86, lookupRisk: 'low', rationaleShort: 'The five-hole is the opening between the goalie’s legs.', rationaleLong: 'Players talk about shooting five-hole when they aim through the space between a goaltender’s pads.', citations: searchCitation('Five-hole hockey', 'five-hole hockey'), isTrickQuestion: false }),
  q({ prompt: 'What is a power play in hockey?', options: ['A skater advantage created by an opponent’s penalty', 'A shootout attempt taken before overtime begins', 'A faceoff at center ice after a video review'], answerIndex: 0, difficulty: 2, subdomain: 'hockey', promptKind: 'term', salienceScore: 87, lookupRisk: 'low', rationaleShort: 'A power play gives one team more skaters because of a penalty.', rationaleLong: 'When one side takes a penalty, the other team gets a temporary man advantage called a power play.', citations: searchCitation('Power play hockey', 'power play hockey') }),
  ...
  q({ prompt: 'What is the name of the ten-event track-and-field competition in the Olympics?', options: ['Decathlon', 'Pentathlon', 'Heptathlon'], answerIndex: 0, difficulty: 2, subdomain: 'olympics', promptKind: 'term', salienceScore: 86, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'That ten-event competition is the decathlon.', rationaleLong: 'The decathlon combines ten track-and-field events into one all-around Olympic contest.', citations: searchCitation('Decathlon Olympics', 'decathlon Olympics') }),
  q({ prompt: 'Which Winter Olympic sport combines cross-country skiing with rifle shooting?', options: ['Biathlon', 'Nordic combined', 'Luge'], answerIndex: 0, difficulty: 2, subdomain: 'olympics', promptKind: 'sport-id', salienceScore: 84, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'That sport is biathlon.', rationaleLong: 'Biathlon is the Winter Olympic event that pairs cross-country skiing with target shooting.', citations: searchCitation('Biathlon Olympics', 'biathlon Olympics') }),
  q({ prompt: 'What is the relay called that carries the Olympic flame toward the host city before the Games begin?', options: ['The torch relay', 'The medal march', 'The champions parade'], answerIndex: 0, difficulty: 3, subdomain: 'olympics', promptKind: 'event', salienceScore: 82, lookupRisk: 'low', isTrickQuestion: true, curveballOnly: true, curveballKind: 'famous-edge-case', rationaleShort: 'That tradition is the torch relay.', rationaleLong: 'The Olympic torch relay carries the flame from Greece toward the host city as a symbol of the coming Games.', citations: searchCitation('Olympic torch relay', 'Olympic torch relay') }),
  q({ prompt: 'In motorsport, what does pole position mean?', options: ['Starting first after posting the fastest qualifying time', 'Serving a stop-and-go penalty at pit exit', 'Leading the most laps before the halfway point'], answerIndex: 0, difficulty: 2, subdomain: 'motorsport', promptKind: 'term', salienceScore: 89, lookupRisk: 'low', themeTags: ['hard-preferred'], isTrickQuestion: true, curveballOnly: false, curveballKind: 'terminology', rationaleShort: 'Pole position means the fastest qualifier starts first.', rationaleLong: 'Pole position belongs to the driver who posts the quickest qualifying time and earns the front starting spot.', citations: searchCitation('Pole position motorsport', 'pole position motorsport') }),
  q({ prompt: 'Which race is part of the Triple Crown of Motorsport alongside the Monaco Grand Prix and the 24 Hours of Le Mans?', options: ['The Indianapolis 500', 'The Daytona 500', 'The Bathurst 1000'], answerIndex: 0, difficulty: 3, subdomain: 'motorsport', promptKind: 'event', salienceScore: 88, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'The third leg is the Indianapolis 500.', rationaleLong: 'The unofficial Triple Crown of Motorsport is usually defined as Monaco, Le Mans, and the Indianapolis 500.', citations: searchCitation('Triple Crown of Motorsport', 'Triple Crown of Motorsport Indianapolis 500') }),
  ...
  q({ prompt: 'In boxing, what is a split decision?', options: ['A win awarded when judges are not unanimous', 'A knockdown caused by a body shot', 'A fight stopped because of a cut'], answerIndex: 0, difficulty: 2, subdomain: 'combat', promptKind: 'term', salienceScore: 82, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'A split decision means the judges were divided.', rationaleLong: 'When the judges do not all score the bout for the same boxer, the result can be announced as a split decision.', citations: searchCitation('Split decision boxing', 'split decision boxing'), isTrickQuestion: false }),
];
...
const CURATED_SPORTS_DAYBREAK_EXPANSION: CuratedTriviaSourceQuestion[] = [
  ...
  q({ prompt: 'In football, what does play-action try to make the defense expect?', options: ['A running play', 'A field goal attempt', 'A quarterback kneel-down'], answerIndex: 0, difficulty: 2, subdomain: 'football', promptKind: 'rule', salienceScore: 85, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'Play-action fakes a run to sell the defense on a rushing play.', rationaleLong: 'On play-action, the quarterback and back mimic a handoff so defenders bite on the run and open up passing lanes.', citations: searchCitation('Play-action football', 'play-action football') }),
  q({ prompt: 'In football, what is a quarterback sneak?', options: ['A short run by the quarterback right after the snap', 'A trick punt run on fourth down', 'A fake spike followed by a deep throw'], answerIndex: 0, difficulty: 2, subdomain: 'football', promptKind: 'term', salienceScore: 84, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'A quarterback sneak is the immediate plunge right after the snap.', rationaleLong: 'Quarterbacks usually sneak the ball behind the center on short-yardage plays when the offense needs a few inches or a yard.', citations: searchCitation('Quarterback sneak', 'quarterback sneak football') }),
  ...
  q({ prompt: 'Which NHL award goes to the league’s top goaltender?', options: ['Vezina Trophy', 'Calder Trophy', 'Selke Trophy'], answerIndex: 0, difficulty: 2, subdomain: 'hockey', promptKind: 'achievement', salienceScore: 82, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'That goalie honor is the Vezina Trophy.', rationaleLong: 'The NHL awards the Vezina Trophy each season to the goaltender judged best at the position.', citations: searchCitation('Vezina Trophy', 'Vezina Trophy') }),
  ...
  q({ prompt: 'What is the penalty box used for in hockey?', options: ['Holding penalized players during their time off the ice', 'Reviewing whether pucks crossed the goal line', 'Storing backup sticks and goalie masks'], answerIndex: 0, difficulty: 2, subdomain: 'hockey', promptKind: 'rule', salienceScore: 82, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'The penalty box is where penalized players serve their time.', rationaleLong: 'When players take penalties in hockey, they sit in the penalty box until their penalty expires or is ended by a goal when the rules allow.', citations: searchCitation('Penalty box hockey', 'penalty box hockey') }),
  q({ prompt: 'In hockey, what do the blue lines mainly separate?', options: ['The offensive, neutral, and defensive zones', 'The two halves of the rink for line changes', 'The legal area for slap shots from the circles'], answerIndex: 0, difficulty: 2, subdomain: 'hockey', promptKind: 'place', salienceScore: 82, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'The blue lines divide the rink into zones.', rationaleLong: 'The two blue lines separate the offensive, neutral, and defensive zones and are central to offside rules.', citations: searchCitation('Blue lines hockey', 'blue lines hockey') }),
  q({ prompt: 'What is a shootout in hockey?', options: ['A tiebreaker of alternating one-on-one attempts after overtime', 'A line brawl that stops the game immediately', 'A drill used during warmups to practice breakaways'], answerIndex: 0, difficulty: 2, subdomain: 'hockey', promptKind: 'event', salienceScore: 84, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'A shootout is the alternating breakaway tiebreaker used after overtime.', rationaleLong: 'When overtime does not decide the game, hockey can use a shootout in which players take alternating attempts against the goalie to settle it.', citations: searchCitation('Shootout hockey', 'shootout hockey') }),
  q({ prompt: 'In golf, what is stroke play?', options: ['A format decided by the lowest total number of strokes', 'A format decided hole by hole against one opponent', 'A tiebreak played only with wedges and putters'], answerIndex: 0, difficulty: 2, subdomain: 'golf', promptKind: 'rule', salienceScore: 84, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'Stroke play is the format decided by total strokes.', rationaleLong: 'Most major golf tournaments use stroke play, where the winner is the player with the lowest cumulative score.', citations: searchCitation('Stroke play golf', 'stroke play golf') }),
  q({ prompt: 'In golf, what is the rough?', options: ['The longer grass beside the fairway', 'The sand around the lip of a bunker', 'The strip between the tee markers and the starter’s hut'], answerIndex: 0, difficulty: 2, subdomain: 'golf', promptKind: 'place', salienceScore: 82, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'The rough is the longer grass off the fairway.', rationaleLong: 'Golfers describe the thicker grass bordering the fairway as the rough because it makes clean shots harder to control.', citations: searchCitation('Rough golf', 'rough golf') }),
  q({ prompt: 'In tennis, what is a volley?', options: ['A shot struck before the ball bounces', 'A serve that clips the top of the net and lands in', 'A rally of exactly four shots'], answerIndex: 0, difficulty: 2, subdomain: 'tennis', promptKind: 'term', salienceScore: 84, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'A volley is struck out of the air before the bounce.', rationaleLong: 'Tennis players volley when they hit the ball before it lands, usually while moving forward or playing near the net.', citations: searchCitation('Volley tennis', 'volley tennis') }),
  q({ prompt: 'In soccer, what is extra time?', options: ['Additional play after regulation in certain knockout matches', 'A bonus stoppage period added only after penalties', 'The clock used to review goals with VAR'], answerIndex: 0, difficulty: 2, subdomain: 'soccer', promptKind: 'event', salienceScore: 83, lookupRisk: 'low', rationaleShort: 'Extra time is the added play after regulation in knockout matches.', rationaleLong: 'Knockout soccer matches that remain level can go to two added periods known as extra time before a possible shootout.', citations: searchCitation('Extra time soccer', 'extra time soccer'), isTrickQuestion: false }),
  q({ prompt: 'Which soccer award often goes to a tournament’s best goalkeeper?', options: ['Golden Glove', 'Golden Boot', 'Golden Ball'], answerIndex: 0, difficulty: 2, subdomain: 'soccer', promptKind: 'achievement', salienceScore: 82, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'That goalkeeping honor is the Golden Glove.', rationaleLong: 'Many major soccer tournaments use the Golden Glove to recognize the standout goalkeeper of the competition.', citations: searchCitation('Golden Glove soccer', 'Golden Glove soccer') }),
  q({ prompt: 'In motorsport, what does the checkered flag signal?', options: ['The race or session has ended', 'A slower car may not be passed', 'The pit lane is closed for weather'], answerIndex: 0, difficulty: 2, subdomain: 'motorsport', promptKind: 'rule', salienceScore: 84, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'The checkered flag signals the finish.', rationaleLong: 'Across many forms of motorsport, the black-and-white checkered flag marks the end of the race or session.', citations: searchCitation('Checkered flag motorsport', 'checkered flag motorsport') }),
  q({ prompt: 'In motorsport, what is a chicane?', options: ['A quick sequence of turns designed to slow the cars', 'The painted box where pole position is marked', 'A timed stop in the pits for extra fuel only'], answerIndex: 0, difficulty: 3, subdomain: 'motorsport', promptKind: 'term', salienceScore: 84, lookupRisk: 'low', rationaleShort: 'A chicane is the quick turn sequence used to reduce speed.', rationaleLong: 'Track designers add chicanes to force heavy braking and directional change, often for safety or overtaking balance.', citations: searchCitation('Chicane motorsport', 'chicane motorsport'), isTrickQuestion: false }),
  q({ prompt: 'In gymnastics, what does winning the all-around title mean?', options: ['Posting the best combined score across the full set of events', 'Recording the single highest score on one apparatus', 'Qualifying every teammate into the final round'], answerIndex: 0, difficulty: 2, subdomain: 'olympics', promptKind: 'achievement', salienceScore: 84, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'The all-around title goes to the best combined performance across events.', rationaleLong: 'Gymnastics crowns the all-around champion based on cumulative scoring across the full slate of apparatus rather than just one event.', citations: searchCitation('Gymnastics all-around', 'gymnastics all-around') }),
];

const GENERAL_SPORTS_TERM_CARDS = parseRows<GeneralSportsTermCard>(
  `
Bye|an automatic advance or an off week without playing|A tiebreak played with one extra skater|A penalty for delaying the restart|82
Seed|a ranking that sets a competitor’s path in a tournament|A player chosen to begin a relay|A warm-up game before standings count|84
Bracket|the diagram that shows tournament matchups and advancement|The painted area under a basketball hoop|The lane where pit crews work during a race|82
Qualifier|an entrant who earned a place through preliminary competition|A referee assigned only to replay decisions|A player activated from the bench during overtime|80
Rematch|a contest between the same opponents again|A replay ordered because of bad weather|A second half played after a scoreless draw|80
Upset|an unexpected win by the side expected to lose|A protest filed after a disputed call|A game postponed after a crowd delay|83
Underdog|the side expected to lose before the contest starts|The defending champion in a return match|The host team in a championship event|82
Defending champion|the reigning titleholder entering the event again|The top seed playing at home|The athlete who won the last qualifying heat|82
Rookie|a first-year player or competitor|A veteran who changes teams midseason|A reserve who starts because of injury|84
Captain|the designated leader of a team on the field, court, or ice|The official who starts the clock|The reserve goalkeeper on the bench|82
Playoffs|the postseason rounds that decide a champion|The games played before rosters are final|A set of matches that only break ties in the standings|86
Preseason|games or matches played before the official season begins|The final phase of a playoff bracket|A title defense staged at a neutral site|80
Exhibition|a contest that does not count in the official standings|A race run only in rainy conditions|A tiebreak used only in championship games|80
Relay|an event in which teammates compete one after another|A scoring system based only on judges’ cards|A penalty where the next foul ends the game|83
Tiebreaker|a method used to decide a tie that still remains|A practice match before the main draw|A replay review that confirms a close call|82
Split decision|a judges’ result where not all judges agree on the winner|A ruling that divides one point between both sides|A race finish decided by a team owner appeal|80
Overtime|an extra period played after regulation ends tied|A stoppage between qualifying sessions|A timeout that carries over between games|86
Sudden death|a format where the next score ends the contest|A rule that voids a score after replay review|A warm-up round held before the final|80
Home opener|a team’s first home game of a season|The first round of a playoff bracket|A match played after switching venues at halftime|79
Road game|a game played at the opponent’s venue|A race run entirely on street pavement|A match moved because the home venue is unavailable|82
Shutout|a game in which one side keeps the other from scoring at all|A victory decided entirely by judges|A win that ends because of weather|84
Comeback|a rally from behind to win or draw level late|A return to the lineup after switching positions|A replay scheduled after a scoring error|81
Podium|the top finishing positions in a medal event|The platform where referees review calls|The row of seats reserved for team owners|81
Quarterfinal|the round with eight competitors or teams left|The final heat before qualifying begins|A replay held a quarter of the way through a season|82
Semifinal|the round immediately before the final|A warm-up event staged after the draw|A tie decided by adding all scores from a season|84
Final|the championship round that decides the winner|The first round after qualifying ends|A review that confirms the last scoring play|84
Wild card|an extra playoff or tournament entrant outside the main automatic qualifiers|A race entry chosen by random draw|A penalty assessed after a bench warning|83
Draft|the selection process used to assign new players to teams|A rule that allows one free substitution|The written protest filed after a match|82
Free agent|a player who is free to sign with any team|A reserve player who can only appear in emergencies|A coach who is allowed to challenge any call|82
Trade deadline|the last date on which teams can make trades that season|The clock limit for choosing a play after a timeout|The final checkpoint before equipment inspection|79
Sweep|winning every game or match in a set or series|Clearing the bases with one hit|A rotation pattern used in relay racing|81
Series|a set of multiple games between the same sides|A ranking list used only before the season|A tie decided by one sudden-death period|80
Home-field advantage|the benefit of playing in familiar home conditions|The right to review one extra call late in a game|The extra point given for winning away from home|84
Match point|a point that would win the entire match if converted|A score that forces the match into overtime|A serve that can be replayed without penalty|84
Photo finish|a result so close it must be checked by image review|A celebration lap after winning a race|A camera angle used only for offside calls|83
Qualifying round|a stage used to narrow the field before the main draw|The final round after a season ends tied|A medal event reserved for top seeds only|80
Doubleheader|two games between the same teams on the same day|A play with two lead blockers in front|A race restart that begins from the second row|82
Lineup|the announced list of starters or batting order|The painted boundary around a goalkeeper|The referee crew assigned to a game|81
Bench|the reserve players not currently in the game|The raised platform where medals are awarded|The penalty area behind a hockey net|80
Substitute|a replacement player entering for another one|A backup official assigned to the replay booth|A team that qualifies without winning its league|82
Timeout|an official stoppage requested by a team or official|A point awarded after repeated delays|A break used only between overtime periods|84
Replay review|an official video check of a call or play|A rematch ordered by the league office|A practice sequence run before qualifying starts|82
Neutral site|a venue that is not the home field of either side|A court with no out-of-bounds markings|A playoff berth awarded by league officials|80
Bench player|a reserve who starts the game on the sideline or bench|A veteran whose points count double late|A captain chosen only for away games|79
Starting lineup|the group of players who begin the game|The teams still alive after the quarterfinals|The order used for a penalty shootout|81
`,
  ([term, definition, distractorA, distractorB, salience]) => ({
    term,
    definition,
    distractorA,
    distractorB,
...
function buildGeneralSportsReserve(
  cards: GeneralSportsTermCard[]
): CuratedTriviaSourceQuestion[] {
  const terms = cards.map((card) => card.term);
  return cards.flatMap((card, index) => {
    const [termA, termB] = pickPeerValues(terms, card.term, index);
    return [
      q({
        prompt: `In sports, what does ${card.term.toLowerCase()} mean?`,
        options: [card.definition, card.distractorA, card.distractorB],
        answerIndex: 0,
        difficulty: 2,
        ...
        lookupRisk: 'low',
        rationaleShort: `${card.term} refers to ${card.definition}.`,
        rationaleLong: `In common sports usage, ${card.term.toLowerCase()} means ${card.definition}.`,
        citations: searchCitation(`${card.term} sports term`, `${card.term} sports term`),
      }),
      q({
        prompt: `What is the sports term for ${card.definition}?`,
        options: buildOptions(card.term, [termA, termB]),
        answerIndex: 0,
        difficulty: 3,
        subdomain: 'general-sports',
        promptKind: 'term',
        salienceScore: Math.max(74, card.salience - 2),
        lookupRisk: 'low',
        rationaleShort: `${card.term} is the term for that situation.`,
        rationaleLong: `Across mainstream sports coverage, ${card.term.toLowerCase()} is the standard term for ${card.definition}.`,
        citations: searchCitation(`${card.term} sports definition reverse`, `${card.term} sports definition`),
      }),
    ];
  });
}
...
const CURATED_SPORTS_DAYBREAK_CURVEBALLS: CuratedTriviaSourceQuestion[] = [
  q({ prompt: 'In football, what is a neutral zone infraction?', options: ['A defensive penalty for entering the neutral zone and causing the offense to react before the snap', 'An offensive penalty for lining up with too many players in the backfield', 'A kicking violation for crossing midfield before the punt is away'], answerIndex: 0, difficulty: 2, subdomain: 'football', promptKind: 'rule', salienceScore: 85, lookupRisk: 'low', isTrickQuestion: true, curveballOnly: true, curveballKind: 'rule-nuance', themeTags: ['hard-preferred'], rationaleShort: 'Neutral zone infraction is the pre-snap defensive penalty that triggers the offense to react.', rationaleLong: 'Officials call neutral zone infraction when a defender enters the neutral zone and causes an immediate offensive response before the snap.', citations: searchCitation('Neutral zone infraction football', 'neutral zone infraction football') }),
  q({ prompt: 'In basketball, what makes a foul flagrant?', options: ['Excessive or dangerous contact beyond a normal personal foul', 'A defender touching the ball over the rim cylinder', 'A shooter stepping on the sideline before releasing a shot'], answerIndex: 0, difficulty: 2, subdomain: 'basketball', promptKind: 'rule', salienceScore: 85, lookupRisk: 'low', isTrickQuestion: false, themeTags: ['hard-preferred'], rationaleShort: 'Flagrant fouls involve excessive or dangerous contact.', rationaleLong: 'Basketball reserves the flagrant designation for contact judged unnecessary or excessive beyond an ordinary personal foul.', citations: searchCitation('Flagrant foul basketball', 'flagrant foul basketball') }),
  q({ prompt: 'In baseball, what is a force out?', options: ['An out made by touching the base a runner is forced to advance to while holding the ball', 'An out made only by tagging the runner with the glove', 'An out recorded when a batter bunts foul with two strikes'], answerIndex: 0, difficulty: 2, subdomain: 'baseball', promptKind: 'rule', salienceScore: 84, lookupRisk: 'low', isTrickQuestion: false, themeTags: ['hard-preferred'], rationaleShort: 'A force out comes from touching the forced base with the ball.', rationaleLong: 'When a runner must advance because the batter became a runner, the defense can get the out by touching the destination base before the runner arrives.', citations: searchCitation('Force out baseball', 'force out baseball') }),
  q({ prompt: 'In baseball, what is a fielder’s choice?', options: ['A play where the fielder gets or tries for a different runner instead of the batter', 'A manager’s option to swap in a new pitcher mid-at-bat', 'A ball ruled fair or foul based on the umpire crew vote'], answerIndex: 0, difficulty: 2, subdomain: 'baseball', promptKind: 'term', salienceScore: 83, lookupRisk: 'low', isTrickQuestion: false, themeTags: ['hard-preferred'], rationaleShort: 'A fielder’s choice is scored when the defense goes after another runner instead of the batter.', rationaleLong: 'Scorekeepers use fielder’s choice when the batter reaches because the defense elects to try for a different runner rather than take the easy out at first.', citations: searchCitation('Fielders choice baseball', 'fielder’s choice baseball') }),
  q({ prompt: 'In hockey, what is a one-timer?', options: ['A shot taken immediately off a pass without settling the puck first', 'A goal that counts only after one video review', 'A line change made with exactly one skater leaving the ice'], answerIndex: 0, difficulty: 2, subdomain: 'hockey', promptKind: 'term', salienceScore: 84, lookupRisk: 'low', rationaleShort: 'A one-timer is fired right away off the pass.', rationaleLong: 'Players use one-timers to attack quickly because they shoot in one motion instead of receiving the puck and setting it first.', citations: searchCitation('One-timer hockey', 'one-timer hockey'), isTrickQuestion: false }),
  q({ prompt: 'In golf, what is a provisional ball?', options: ['A second ball played in case the original might be lost or out of bounds', 'A free replacement ball used after a hole-in-one', 'A practice shot allowed on the first tee in match play'], answerIndex: 0, difficulty: 2, subdomain: 'golf', promptKind: 'rule', salienceScore: 84, lookupRisk: 'low', rationaleShort: 'A provisional ball is the backup ball played in case the original might be lost or out of bounds.', rationaleLong: 'Golf allows a provisional so players do not have to walk all the way back if the original ball turns out to be lost or out of bounds.', citations: searchCitation('Provisional ball golf', 'provisional ball golf'), isTrickQuestion: false }),
  ...
  q({ prompt: 'In combat sports, what does southpaw describe?', options: ['A left-handed stance with the right foot forward', 'A fighter who prefers body shots over head shots', 'A ruleset that allows only standing strikes'], answerIndex: 0, difficulty: 2, subdomain: 'combat', promptKind: 'term', salienceScore: 83, lookupRisk: 'low', rationaleShort: 'Southpaw is the left-handed stance with the right foot in front.', rationaleLong: 'Combat sports call the mirror-image lefty setup southpaw, which usually places the right foot and right hand forward.', citations: searchCitation('Southpaw boxing', 'southpaw boxing'), isTrickQuestion: false }),
  q({ prompt: 'In football, what does a touchback do?', options: ['It brings the ball out to start a drive after it becomes dead in the end zone', 'It lets the return team attempt an unopposed free kick', 'It awards one point to the defense after a blocked punt'], answerIndex: 0, difficulty: 2, subdomain: 'football', promptKind: 'rule', salienceScore: 82, lookupRisk: 'low', isTrickQuestion: false, themeTags: ['hard-preferred'], rationaleShort: 'A touchback brings the ball out to start a drive.', rationaleLong: 'When certain kicks or turnovers become dead in the end zone, the receiving team resumes play from the touchback spot instead of returning the ball.', citations: searchCitation('Touchback football rule', 'touchback football rule') }),
  q({ prompt: 'In basketball, when is goaltending called?', options: ['When a defender illegally interferes with a shot on its way down or over the rim', 'When an offense takes more than five seconds to inbound', 'When a shooter lands on the three-point line after release'], answerIndex: 0, difficulty: 2, subdomain: 'basketball', promptKind: 'rule', salienceScore: 82, lookupRisk: 'low', isTrickQuestion: false, themeTags: ['hard-preferred'], rationaleShort: 'Goaltending is called when a defender illegally interferes with a shot on its scoring path.', rationaleLong: 'Basketball rules call goaltending when a defender touches a shot that is descending toward the rim or is already in the cylinder with a chance to score.', citations: searchCitation('Goaltending basketball rule', 'goaltending basketball rule') }),
  q({ prompt: 'In baseball, what does a sacrifice fly allow?', options: ['A runner to score after a caught fly ball', 'A runner to take two bases on catcher interference', 'A batter to keep hitting after fouling off strike three'], answerIndex: 0, difficulty: 2, subdomain: 'baseball', promptKind: 'rule', salienceScore: 81, lookupRisk: 'low', isTrickQuestion: false, themeTags: ['hard-preferred'], rationaleShort: 'A sacrifice fly allows a runner to score after the catch.', rationaleLong: 'A sacrifice fly happens when a deep fly ball is caught but still gives a runner enough time to tag and score.', citations: searchCitation('Sacrifice fly rule baseball', 'sacrifice fly baseball rule') }),
  q({ prompt: 'In hockey, what happens on a delayed penalty?', options: ['Play continues until the penalized team touches the puck', 'The referee sends both teams to the bench for a timeout', 'The next goal automatically wipes out the penalty before it starts'], answerIndex: 0, difficulty: 2, subdomain: 'hockey', promptKind: 'rule', salienceScore: 82, lookupRisk: 'low', isTrickQuestion: false, themeTags: ['hard-preferred'], rationaleShort: 'Play continues on a delayed penalty until the offending team touches the puck.', rationaleLong: 'Hockey allows the non-offending team to keep its possession and scoring chance alive on a delayed penalty until the guilty side regains touch of the puck.', citations: searchCitation('Delayed penalty hockey rule', 'delayed penalty hockey rule') }),
  q({ prompt: 'In golf, what does match play count instead of total strokes?', options: ['Holes won', 'Greens reached in regulation', 'Only scores on par threes'], answerIndex: 0, difficulty: 2, subdomain: 'golf', promptKind: 'rule', salienceScore: 81, lookupRisk: 'low', isTrickQuestion: false, themeTags: ['hard-preferred'], rationaleShort: 'Match play counts holes won instead of total strokes.', rationaleLong: 'In match play, each hole is its own contest, so the score is based on who wins more holes rather than who needs the fewest strokes overall.', citations: searchCitation('Match play golf scoring', 'match play golf scoring') }),
  q({ prompt: 'In tennis, what is a break point for the receiver?', options: ['A point that would win the game against the server', 'A point replayed because a let interrupted the serve', 'A point played after both players change racquets'], answerIndex: 0, difficulty: 2, subdomain: 'tennis', promptKind: 'term', salienceScore: 82, lookupRisk: 'low', isTrickQuestion: false, themeTags: ['hard-preferred'], rationaleShort: 'A break point is a return point that would win the game against the server.', rationaleLong: 'Tennis calls it break point when the returner is one point away from breaking serve and taking the game.', citations: searchCitation('Break point receiver tennis', 'break point receiver tennis') }),
  q({ prompt: 'In soccer, what does stoppage time make up for?', options: ['Time lost to injuries, substitutions, and other delays', 'Extra goals needed to decide away-goals tiebreakers', 'The halftime break before extra time begins'], answerIndex: 0, difficulty: 2, subdomain: 'soccer', promptKind: 'rule', salienceScore: 82, lookupRisk: 'low', isTrickQuestion: false, themeTags: ['hard-preferred'], rationaleShort: 'Stoppage time makes up for delays during the half.', rationaleLong: 'Referees add stoppage time to recover minutes lost to injuries, substitutions, time-wasting, and other interruptions in play.', citations: searchCitation('Stoppage time soccer rule', 'stoppage time soccer rule') }),
  q({ prompt: 'In motorsport, what does a safety car do to the field?', options: ['It slows and bunches the cars together while the race is neutralized', 'It sends only the backmarkers into pit lane for a restart', 'It awards an automatic pass-through penalty to the leader'], answerIndex: 0, difficulty: 2, subdomain: 'motorsport', promptKind: 'rule', salienceScore: 82, lookupRisk: 'low', isTrickQuestion: false, themeTags: ['hard-preferred'], rationaleShort: 'A safety car slows and bunches the field during a neutralization.', rationaleLong: 'Race control uses the safety car to control speed and keep the field grouped while marshals handle danger on track.', citations: searchCitation('Safety car neutralizes field', 'safety car neutralizes field motorsport') }),
  q({ prompt: 'In football, what is a two-minute drill?', options: ['A hurry-up drive run late in a half or game', 'A special teams unit with only two linemen', 'A practice script used only on Thursdays'], answerIndex: 0, difficulty: 2, subdomain: 'football', promptKind: 'term', salienceScore: 82, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'A two-minute drill is the fast late-half or late-game drive.', rationaleLong: 'Football teams use a two-minute drill when they need to move quickly late in a half, usually with hurry-up tempo and sideline awareness.', citations: searchCitation('Two-minute drill football', 'two-minute drill football') }),
  q({ prompt: 'In football, what is a screen pass designed to do?', options: ['Let blockers set up in front of a short throw', 'Move the quarterback outside the pocket for a deep shot', 'Stop the clock after a completion in the middle of the field'], answerIndex: 0, difficulty: 2, subdomain: 'football', promptKind: 'term', salienceScore: 81, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'A screen pass lets blockers form in front of a short throw.', rationaleLong: 'On a screen pass, the offense sells another action, then throws short so blockers can get in front of the ball carrier in space.', citations: searchCitation('Screen pass football', 'screen pass football') }),
  q({ prompt: 'In basketball, what does being in the bonus mean?', options: ['The fouled team earns free throws on more non-shooting fouls', 'A made basket is worth an extra point in the final minute', 'Coaches may challenge one extra call per half'], answerIndex: 0, difficulty: 2, subdomain: 'basketball', promptKind: 'rule', salienceScore: 82, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'The bonus means additional non-shooting fouls lead to free throws.', rationaleLong: 'Once a team penalty limit is reached, the opponent enters the bonus and starts shooting free throws for many non-shooting fouls.', citations: searchCitation('Bonus basketball free throws', 'bonus basketball free throws') }),
  q({ prompt: 'In baseball, what is a full count?', options: ['Three balls and two strikes on the batter', 'Bases loaded with two outs', 'A scorebook entry showing every player reached base'], answerIndex: 0, difficulty: 2, subdomain: 'baseball', promptKind: 'term', salienceScore: 82, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'A full count is three balls and two strikes.', rationaleLong: 'Baseball calls 3-and-2 a full count because the batter has used the entire allowance of balls and strikes before a walk or strikeout.', citations: searchCitation('Full count baseball', 'full count baseball') }),
  q({ prompt: 'In baseball, what is a ground-rule double?', options: ['A hit that bounces into the stands or out of play and automatically gives the batter two bases', 'A double play that can only happen on a ground ball', 'A grounder that scores two runs regardless of where runners started'], answerIndex: 0, difficulty: 2, subdomain: 'baseball', promptKind: 'rule', salienceScore: 81, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'A ground-rule double automatically gives the batter two bases.', rationaleLong: 'When a fair ball bounces out of play under the ground rules, the batter is awarded second base without needing to keep running.', citations: searchCitation('Ground-rule double baseball', 'ground-rule double baseball') }),
  q({ prompt: 'In hockey, what is forechecking?', options: ['Applying pressure in the offensive zone to disrupt the breakout', 'Changing lines only after dumping the puck in', 'A goalie leaving the crease to challenge a shooter'], answerIndex: 0, difficulty: 2, subdomain: 'hockey', promptKind: 'term', salienceScore: 81, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'Forechecking is offensive-zone pressure to disrupt the breakout.', rationaleLong: 'Teams forecheck by pressuring puck carriers and passing lanes in the attacking zone to force turnovers or rushed exits.', citations: searchCitation('Forechecking hockey', 'forechecking hockey') }),
  q({ prompt: 'In golf, what is the fringe?', options: ['The closely mown area that surrounds the putting green', 'The deep rough outside a fairway bunker', 'The strip between the tee markers and the score board'], answerIndex: 0, difficulty: 2, subdomain: 'golf', promptKind: 'place', salienceScore: 80, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'The fringe is the short grass around the green.', rationaleLong: 'Golfers call the ring of closely cut grass surrounding the putting surface the fringe, a zone often played with putts or bump-and-runs.', citations: searchCitation('Fringe golf', 'fringe golf') }),
  q({ prompt: 'In tennis, what does it mean to break serve?', options: ['Win a game while the opponent is serving', 'Hit a serve so hard the strings snap', 'Replay a point because the serve clipped the net'], answerIndex: 0, difficulty: 2, subdomain: 'tennis', promptKind: 'achievement', salienceScore: 82, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'Breaking serve means winning the return game.', rationaleLong: 'Because holding serve is such an advantage in tennis, taking a game on the opponent’s serve is called breaking serve.', citations: searchCitation('Break serve tennis', 'break serve tennis') }),
  q({ prompt: 'In soccer, what is a set piece?', options: ['A restart such as a free kick, corner, or throw-in', 'A tactical shift that changes the team’s formation mid-match', 'A pass played back to the goalkeeper under pressure'], answerIndex: 0, difficulty: 2, subdomain: 'soccer', promptKind: 'term', salienceScore: 81, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'A set piece is a structured restart like a free kick or corner.', rationaleLong: 'Soccer uses set piece for restarts such as corners and free kicks, where teams can run planned routines instead of open-play patterns.', citations: searchCitation('Set piece soccer', 'set piece soccer') }),
  q({ prompt: 'In soccer, what is a through ball?', options: ['A pass played into space behind the defense for a runner', 'A cross hit all the way through the penalty area untouched', 'A clearance driven straight through the middle of the field'], answerIndex: 0, difficulty: 2, subdomain: 'soccer', promptKind: 'term', salienceScore: 81, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'A through ball is threaded into space behind the defense.', rationaleLong: 'A through ball is meant to split defenders and release a teammate into open space rather than simply go to feet.', citations: searchCitation('Through ball soccer', 'through ball soccer') }),
  q({ prompt: 'In motorsport handling, what is oversteer?', options: ['The rear tires losing grip so the car rotates more than intended', 'The front tires refusing to turn enough for the corner', 'A penalty for weaving during braking'], answerIndex: 0, difficulty: 2, subdomain: 'motorsport', promptKind: 'term', salienceScore: 80, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'Oversteer is when the rear steps out and the car rotates too much.', rationaleLong: 'Drivers describe oversteer when the rear tires lose grip first, causing the car to rotate more sharply than the driver intended.', citations: searchCitation('Oversteer motorsport', 'oversteer motorsport') }),
  q({ prompt: 'In track and field, what is a heat?', options: ['A preliminary race used to sort competitors before later rounds', 'A tie-breaking sprint run after the final', 'A lane-violation warning given before the start'], answerIndex: 0, difficulty: 2, subdomain: 'olympics', promptKind: 'event', salienceScore: 80, lookupRisk: 'low', themeTags: ['hard-preferred'], rationaleShort: 'A heat is a preliminary race that helps decide who advances.', rationaleLong: 'Track and field uses heats to divide large fields into early races before the semifinals or final round.', citations: searchCitation('Track and field heat', 'track and field heat') }),
];

const CURATED_SPORTS_MAINSTREAM_HARD_DEPTH: CuratedTriviaSourceQuestion[] = [
  q({
    prompt: 'Which NHL trophy is awarded to the player with the most regular-season points?',
    options: ['Art Ross Trophy', 'Conn Smythe Trophy', 'Lady Byng Trophy'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'hockey',
    promptKind: 'achievement',
    salienceScore: 79,
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'The Art Ross Trophy goes to the NHL points leader.',
    rationaleLong: 'The NHL awards the Art Ross Trophy each season to the player who finishes with the most points.',
    citations: searchCitation('Art Ross Trophy', 'Art Ross Trophy NHL'),
  }),
  q({
    prompt: 'In golf, what is an albatross?',
    options: ['A score of three under par on a hole', 'A playoff won on the first extra hole', 'A putt made from off the green'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'golf',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'An albatross is three under par on a single hole.',
    rationaleLong: 'Golf uses albatross for the rare score of three strokes under par on one hole, sometimes also called a double eagle.',
    citations: searchCitation('Albatross golf', 'albatross golf'),
  }),
  q({
    prompt: 'In tennis, what is a walkover?',
    options: ['Advancing because an opponent cannot start the match', 'Winning a set without losing a point', 'Serving underhand by surprise'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'tennis',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'A walkover means a player advances because the opponent cannot begin the match.',
    rationaleLong: 'Tennis records a walkover when one player moves on without playing because the opponent withdraws before the match starts.',
    citations: searchCitation('Walkover tennis', 'walkover tennis'),
  }),
  q({
    prompt: 'Which soccer award is commonly given to the best goalkeeper at a major tournament?',
    options: ['Golden Glove', 'Golden Boot', 'Ballon d’Or'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'soccer',
    promptKind: 'achievement',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'The best goalkeeper often receives the Golden Glove.',
    rationaleLong: 'Major soccer tournaments commonly use Golden Glove for the award honoring the top goalkeeper.',
    citations: searchCitation('Golden Glove soccer', 'Golden Glove soccer tournament'),
  }),
  q({
    prompt: 'In racing, what is a formation lap?',
    options: ['The lap run before the start to get the field in order', 'The bonus lap awarded after a fastest qualifying time', 'The final lap completed behind the checkered flag'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'motorsport',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'The formation lap is the lap before the start that organizes the grid.',
    rationaleLong: 'Motorsport uses the formation lap to warm tires, check systems, and bring the field into proper starting order before racing begins.',
    citations: searchCitation('Formation lap motorsport', 'formation lap motorsport'),
  }),
  q({
    prompt: 'In boxing, what is an orthodox stance?',
    options: ['A right-handed stance with the left foot forward', 'A defensive shell used only on the ropes', 'A round scored entirely on jabs'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'combat',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'An orthodox stance is the standard right-handed boxing stance.',
    rationaleLong: 'Boxing calls the common right-handed setup orthodox, usually placing the left foot and left hand forward.',
    citations: searchCitation('Orthodox stance boxing', 'orthodox stance boxing'),
  }),
  q({
    prompt: 'Which track-and-field event combines ten disciplines into one overall competition?',
    options: ['Decathlon', 'Heptathlon', 'Pentathlon'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'olympics',
    promptKind: 'event',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'The decathlon is the ten-discipline combined event.',
    rationaleLong: 'Track and field uses decathlon for the combined competition built from ten separate disciplines scored across a full program.',
    citations: searchCitation('Decathlon event', 'decathlon track and field'),
  }),
  q({
    prompt: 'Which NFL award is presented each season to the league’s top defensive player?',
    options: ['Defensive Player of the Year', 'Walter Payton Man of the Year', 'Comeback Player of the Year'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'football',
    promptKind: 'achievement',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'That honor is Defensive Player of the Year.',
    rationaleLong: 'The NFL gives Defensive Player of the Year to the standout defender of the season.',
    citations: searchCitation('NFL Defensive Player of the Year', 'NFL Defensive Player of the Year'),
  }),
  q({
    prompt: 'Which award goes to the most valuable player of the Super Bowl?',
    options: ['Super Bowl MVP', 'Walter Payton Man of the Year', 'Bert Bell Award'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'football',
    promptKind: 'achievement',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'That honor is Super Bowl MVP.',
    rationaleLong: 'The NFL presents the Super Bowl MVP award to the most valuable player in the championship game.',
    citations: searchCitation('Super Bowl MVP award', 'Super Bowl MVP award'),
  }),
  q({
    prompt: 'Which NBA award honors the league’s top reserve player each season?',
    options: ['Sixth Man of the Year', 'Most Improved Player', 'Clutch Player of the Year'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'achievement',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'That award is Sixth Man of the Year.',
    rationaleLong: 'The NBA’s Sixth Man of the Year Award recognizes the best player who primarily comes off the bench.',
    citations: searchCitation('NBA Sixth Man of the Year', 'NBA Sixth Man of the Year'),
  }),
  q({
    prompt: 'In baseball scoring, what does WHIP measure?',
    options: ['Walks and hits allowed per inning pitched', 'Wins plus home runs in postseason play', 'Weighted hard-contact index percentage'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'WHIP measures walks and hits allowed per inning pitched.',
    rationaleLong: 'Baseball uses WHIP as a shorthand stat for how many walks and hits a pitcher allows per inning pitched.',
    citations: searchCitation('WHIP baseball stat', 'WHIP baseball stat'),
  }),
  q({
    prompt: 'Which trophy goes to the AFC champion before the Super Bowl?',
    options: ['Lamar Hunt Trophy', 'George Halas Trophy', 'Walter Camp Award'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'football',
    promptKind: 'achievement',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'The AFC champion receives the Lamar Hunt Trophy.',
    rationaleLong: 'The NFL presents the Lamar Hunt Trophy to the team that wins the AFC Championship Game and advances to the Super Bowl.',
    citations: searchCitation('Lamar Hunt Trophy AFC champion', 'Lamar Hunt Trophy AFC champion'),
  }),
  q({
    prompt: 'In the NFL, what does the franchise tag allow a team to do?',
    options: ['Keep a pending free agent on a one-year tender at a preset salary formula', 'Add one extra player to the active roster during the playoffs', 'Challenge any officiating call in the final two minutes'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'football',
    promptKind: 'rule',
    ...
    lookupRisk: 'medium',
    themeTags: ['hard-preferred'],
    rationaleShort: 'The franchise tag keeps a pending free agent on a one-year tender.',
    rationaleLong: 'NFL teams can use the franchise tag to retain a top unsigned player on a one-year contract whose salary is set by a league formula.',
    citations: searchCitation('NFL franchise tag rule', 'NFL franchise tag rule'),
  }),
  q({
    prompt: 'In basketball, what is a clear-path foul?',
    options: ['A foul on a defender that illegally stops a transition scoring chance with no defender ahead', 'A foul for setting an illegal screen above the three-point line', 'A technical assessed for arguing after a made basket'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'rule',
    ...
    themeTags: ['hard-preferred'],
    rationaleShort: 'A clear-path foul illegally takes away a transition scoring chance.',
    rationaleLong: 'Basketball uses a clear-path foul when a defender stops a breakaway opportunity with no defender properly ahead of the play.',
    citations: searchCitation('Clear path foul basketball', 'clear path foul basketball'),
  }),
  q({
    prompt: 'In basketball, what makes a foul a flagrant 2?',
    options: ['It is judged unnecessary and excessive enough for ejection', 'It happens against a shooter behind the arc', 'It is the second team foul of an overtime period'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'rule',
    ...
    curveballKind: 'rule-nuance',
    themeTags: ['hard-preferred'],
    rationaleShort: 'A flagrant 2 is serious enough to bring an ejection.',
    rationaleLong: 'Basketball reserves the flagrant 2 category for contact considered both unnecessary and excessive, which carries an automatic ejection.',
    citations: searchCitation('Flagrant 2 basketball rule', 'flagrant 2 basketball rule'),
  }),
  q({
    prompt: 'In baseball, what is a balk?',
    options: ['An illegal pitching motion that can advance runners', 'A swing checked by the first-base umpire', 'A pop fly lost in the sun by an infielder'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'rule',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'A balk is an illegal move by the pitcher that can move runners up.',
    rationaleLong: 'Baseball calls a balk when the pitcher makes an illegal motion or deception while runners are on base, and the runners are typically awarded the next base.',
    citations: searchCitation('Balk baseball rule', 'balk baseball rule'),
  }),
  q({
    prompt: 'In baseball stats, what does OPS combine?',
    options: ['On-base percentage and slugging percentage', 'Outs per save and pitch speed', 'Official plate appearances and stolen bases'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'record',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'OPS combines on-base percentage with slugging percentage.',
    rationaleLong: 'OPS is the shorthand stat created by adding a hitter’s on-base percentage and slugging percentage together.',
    citations: searchCitation('OPS baseball stat', 'OPS baseball stat'),
  }),
  q({
    prompt: 'In baseball, what is a quality start?',
    options: ['At least six innings pitched while allowing three or fewer earned runs', 'A start with more strikeouts than hits allowed', 'A game in which the starter earns the win and a save'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'record',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'A quality start is six-plus innings with three or fewer earned runs.',
    rationaleLong: 'The quality start stat credits starting pitchers who work at least six innings and give up no more than three earned runs.',
    citations: searchCitation('Quality start baseball', 'quality start baseball'),
  }),
  q({
    prompt: 'In hockey, what is a Gordie Howe hat trick?',
    options: ['A goal, an assist, and a fight in the same game', 'Three power-play goals by one player', 'A goal in regulation, overtime, and the shootout'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'hockey',
    promptKind: 'achievement',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'A Gordie Howe hat trick is a goal, an assist, and a fight in one game.',
    rationaleLong: 'Hockey folklore uses Gordie Howe hat trick for the unusual combination of a goal, an assist, and a fight in the same game.',
    citations: searchCitation('Gordie Howe hat trick', 'Gordie Howe hat trick'),
  }),
  q({
    prompt: 'In hockey stats, what does plus-minus try to capture?',
    options: ['Whether more even-strength goals are scored for or against a player’s team while that player is on the ice', 'How many minutes a player averages per shift', 'The gap between shots on goal and total shot attempts'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'hockey',
    promptKind: 'record',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'Plus-minus tracks goal differential while a player is on the ice at even strength.',
    rationaleLong: 'Hockey’s plus-minus statistic reflects whether a player’s team scores or allows more even-strength goals while that player is on the ice.',
    citations: searchCitation('Plus minus hockey stat', 'plus minus hockey stat'),
  }),
  q({
    prompt: 'In golf tournaments, what is the cut?',
    options: ['The score line players must beat or match to continue into later rounds', 'The playoff hole chosen to break a tie for first place', 'The penalty for grounding a club in a bunker'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'golf',
    promptKind: 'event',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'The cut is the threshold that determines who stays in the tournament.',
    rationaleLong: 'Multi-round golf events usually make a cut after the early rounds so only players at or above the qualifying score line continue.',
    citations: searchCitation('Golf tournament cut', 'golf tournament cut'),
  }),
  q({
    prompt: 'In tennis, what is an unforced error?',
    options: ['A mistake a player makes without obvious pressure from the opponent', 'A serve replayed after clipping the net', 'A point lost because of a code violation only'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'tennis',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'An unforced error is a mistake made without clear pressure from the opponent.',
    rationaleLong: 'Tennis uses unforced error for a miss that comes from the striker’s own mistake rather than a shot the opponent clearly forced.',
    citations: searchCitation('Unforced error tennis', 'unforced error tennis'),
  }),
  q({
    prompt: 'In tennis, what does it mean to be seeded in a tournament?',
    options: ['A player is placed in the draw to separate top contenders early', 'A player automatically starts every set serving first', 'A player earns extra ranking points for qualifying'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'tennis',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'Seeding is used to spread top players through the draw.',
    rationaleLong: 'Tournament seeding is designed so the strongest players are positioned apart in the bracket instead of meeting immediately.',
    citations: searchCitation('Seeded player tennis tournament', 'seeded player tennis tournament'),
  }),
  q({
    prompt: 'In soccer, what is a clean sheet?',
    options: ['A match in which a team allows no goals', 'A match completed without yellow cards', 'A scoreline with no goals at halftime only'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'soccer',
    promptKind: 'achievement',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'A clean sheet means finishing the match without conceding a goal.',
    rationaleLong: 'Soccer awards a team or goalkeeper a clean sheet when the opponent fails to score over the course of the match.',
    citations: searchCitation('Clean sheet soccer', 'clean sheet soccer'),
  }),
  q({
    prompt: 'In soccer tactics, what is a false nine?',
    options: ['A center forward who drops deep instead of staying on the back line', 'A winger switched to fullback late in a match', 'A defender marked to take every goal kick short'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'soccer',
    promptKind: 'term',
    ...
    lookupRisk: 'medium',
    themeTags: ['hard-preferred'],
    rationaleShort: 'A false nine is a central attacker who keeps dropping away from the usual striker space.',
    rationaleLong: 'The false nine role pulls a nominal striker deeper into midfield or pockets of space, often to disrupt center backs and open running lanes for others.',
    citations: searchCitation('False nine soccer tactic', 'false nine soccer tactic'),
  }),
  q({
    prompt: 'Which multi-event track competition is built around seven disciplines instead of ten?',
    options: ['Heptathlon', 'Decathlon', 'Pentathlon only'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'olympics',
    promptKind: 'event',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'The seven-event combined competition is the heptathlon.',
    rationaleLong: 'Track and field uses heptathlon for the combined event made up of seven disciplines rather than the ten used in the decathlon.',
    citations: searchCitation('Heptathlon event', 'heptathlon track and field'),
  }),
  q({
    prompt: 'In Formula 1, what does DRS do?',
    options: ['It reduces rear-wing drag in designated zones to aid overtaking', 'It automatically slows the leader under safety-car conditions', 'It assigns pit-lane priority to the car ahead on track'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'motorsport',
    promptKind: 'rule',
    ...
    lookupRisk: 'medium',
    themeTags: ['hard-preferred'],
    rationaleShort: 'DRS reduces drag to help with overtaking.',
    rationaleLong: 'Formula 1 uses DRS to open part of the rear wing in approved zones, cutting drag and increasing straight-line speed for passing attempts.',
    citations: searchCitation('DRS Formula 1', 'DRS Formula 1'),
  }),
  q({
    prompt: 'In motorsport, what is parc ferme?',
    options: ['The secured condition that limits changes to a car after qualifying or before post-race inspection', 'The warm-up lane used before the formation lap', 'The gravel runoff zone beyond the final corner'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'motorsport',
    promptKind: 'term',
    ...
    lookupRisk: 'medium',
    themeTags: ['hard-preferred'],
    rationaleShort: 'Parc ferme is the secured condition that restricts car changes.',
    rationaleLong: 'Motorsport rules use parc ferme to limit how much teams can alter a car after qualifying or before inspection, preserving competitive integrity.',
    citations: searchCitation('Parc ferme motorsport', 'parc ferme motorsport'),
  }),
];

const CURATED_SPORTS_MID_DEPTH: CuratedTriviaSourceQuestion[] = [
  q({
    prompt: 'Which Winter Olympic event pairs cross-country skiing with rifle shooting?',
    options: ['Biathlon', 'Speed skating', 'Curling'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'olympics',
    promptKind: 'event',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'That event is biathlon.',
    rationaleLong: 'Biathlon combines cross-country skiing with rifle shooting in a single Winter Olympic event.',
    citations: searchCitation('Biathlon event', 'biathlon winter olympics'),
  }),
  q({
    prompt: 'In boxing, what does a unanimous decision mean?',
    options: ['All judges scored the fight for the same boxer', 'The fight ended with both boxers knocked down', 'The result was changed by instant replay'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'combat',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    rationaleShort: 'A unanimous decision means every judge picked the same winner.',
    rationaleLong: 'Combat sports call it a unanimous decision when all judges score the bout for the same boxer.',
    citations: searchCitation('Unanimous decision boxing', 'unanimous decision boxing'),
  }),
  q({
    prompt: 'In motorsport, what does pole position mean at the start of a race?',
    options: ['The fastest qualifier starts first', 'The final-place qualifier starts from pit lane', 'The defending champion starts on the inside line'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'motorsport',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    rationaleShort: 'Pole position means the fastest qualifier starts first.',
    rationaleLong: 'Pole position belongs to the driver who posts the quickest qualifying time and earns the front starting place.',
    citations: searchCitation('Pole position racing', 'pole position racing'),
  }),
  q({
    prompt: 'What is the Vezina Trophy awarded for in the NHL?',
    options: ['Best goaltender', 'Most points scored', 'Best defensive forward'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'hockey',
    promptKind: 'achievement',
    salienceScore: 81,
    lookupRisk: 'low',
    rationaleShort: 'The Vezina Trophy honors the NHL’s top goaltender.',
    rationaleLong: 'The NHL awards the Vezina Trophy each season to the goaltender judged best at the position.',
    citations: searchCitation('Vezina Trophy award', 'Vezina Trophy award'),
  }),
  q({
    prompt: 'What does MLB’s Rookie of the Year Award honor?',
    options: ['The top first-year player in a league', 'The best postseason hitter', 'The pitcher with the lowest ERA'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'achievement',
    salienceScore: 79,
    lookupRisk: 'low',
    rationaleShort: 'It honors the best rookie in a league.',
    rationaleLong: 'Major League Baseball gives a Rookie of the Year Award in each league to its standout first-year player.',
    citations: searchCitation('MLB Rookie of the Year Award', 'MLB Rookie of the Year Award'),
  }),
  q({
    prompt: 'What does the Golden Glove usually recognize at a major soccer tournament?',
    options: ['The best goalkeeper', 'The top goal scorer', 'The tournament MVP'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'soccer',
    promptKind: 'achievement',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'The Golden Glove usually goes to the best goalkeeper.',
    rationaleLong: 'Major soccer tournaments commonly use the Golden Glove to honor the standout goalkeeper of the competition.',
    citations: searchCitation('Golden Glove goalkeeper award', 'Golden Glove goalkeeper award soccer'),
  }),
];
...
const CURATED_SPORTS_CURVEBALL_BENCH: CuratedTriviaSourceQuestion[] = [
  ...
  q({
    prompt: 'In football, what is intentional grounding?',
    options: ['A penalty for throwing the ball away to avoid a sack without an eligible target nearby', 'A penalty for spiking the ball after a touchdown', 'A rule that stops a kick from being returned'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'football',
    promptKind: 'rule',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'Intentional grounding punishes a quarterback for dumping the ball away illegally.',
    rationaleLong: 'When a passer under pressure throws the ball away without an eligible receiver in the area and outside the normal exceptions, officials can call intentional grounding.',
  }),
  q({
    prompt: 'In football, what does a fair catch let the return team do?',
    options: ['Catch a kick and stop the play without being hit', 'Advance the ball after any penalty flag', 'Retry a missed extra point from the 2-yard line'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'football',
    promptKind: 'rule',
    ...
    curveballKind: 'rule-nuance',
    themeTags: ['hard-preferred'],
    rationaleShort: 'A fair catch ends the return as soon as the kick is caught cleanly.',
    rationaleLong: 'By signaling for a fair catch, a returner gives up the chance to run in exchange for making the catch without being hit by the coverage team.',
  }),
  q({
    prompt: 'In basketball, what is a backcourt violation?',
    options: ['Returning the ball to the backcourt after establishing frontcourt control', 'Blocking a shot after it hits the backboard', 'Taking more than ten seconds to attempt a free throw'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'rule',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'A backcourt violation happens when the offense illegally sends the ball back across midcourt.',
    rationaleLong: 'Once the offense establishes control in the frontcourt, it generally cannot return the ball to the backcourt without giving the ball to the defense for a violation.',
  }),
  q({
    prompt: 'In basketball, what does finishing an and-one mean?',
    options: ['Making the basket and drawing a foul for one free throw', 'Scoring on a shot from beyond the arc and the foul line', 'Winning a game by a single point in overtime'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'term',
    ...
    isTrickQuestion: true,
    curveballKind: 'terminology',
    rationaleShort: 'An and-one is a made basket plus a foul and free throw.',
    rationaleLong: 'Players call it an and-one when the shot still falls despite contact, giving the scorer one additional free throw to try for an extra point.',
  }),
  q({
    prompt: 'In basketball, what causes a shot clock violation?',
    options: ['Failing to shoot before the possession clock expires', 'Dribbling the ball off your foot out of bounds', 'Calling timeout when your team has none left'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'rule',
    ...
    isTrickQuestion: true,
    curveballKind: 'rule-nuance',
    rationaleShort: 'A shot clock violation happens when a team runs out of possession time.',
    rationaleLong: 'The offense must get a legal shot off before the shot clock hits zero, so letting that timer expire gives the ball to the other team.',
  }),
  q({
    prompt: 'In baseball, what does the infield fly rule prevent?',
    options: ['Infielders from intentionally dropping an easy pop-up to turn a cheap double play', 'Outfielders from catching a ball across the foul line', 'Pitchers from quick-pitching with runners on base'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'rule',
    ...
    curveballKind: 'rule-nuance',
    themeTags: ['hard-preferred'],
    rationaleShort: 'The infield fly rule stops the defense from turning a cheap trap double play.',
    rationaleLong: 'With runners forced to stay close to their bases, the infield fly rule protects them when a routine pop-up could otherwise be dropped on purpose and turned into multiple outs.',
  }),
  q({
    prompt: 'In baseball scoring, what is a save?',
    options: ['Credit for a reliever who finishes a win under qualifying conditions', 'A defensive play that robs a home run', 'A baserunning advance that avoids a force out'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'term',
    ...
    curveballKind: 'terminology',
    themeTags: ['hard-preferred'],
    rationaleShort: 'A save is credited to a reliever who closes out a win in the right situation.',
    rationaleLong: 'Baseball awards a save when a reliever preserves the lead at the end of a game while meeting the rulebook conditions for that statistic.',
  }),
  q({
    prompt: 'In baseball, what does RBI stand for on the stat line?',
    options: ['Runs batted in', 'Runners brought in', 'Recorded batting impact'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'term',
    ...
    isTrickQuestion: false,
    rationaleShort: 'RBI stands for runs batted in.',
    rationaleLong: 'A batter earns RBI credit for offensive plays that bring runners home, so scoreboards and box scores shorten the category to runs batted in.',
  }),
  q({
    prompt: 'In hockey, what is icing?',
    options: ['Sending the puck the length of the ice without a touch and without legal exception', 'Knocking the net loose to stop play', 'A minor penalty for hooking a skater from behind'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'hockey',
    promptKind: 'rule',
    ...
    curveballKind: 'rule-nuance',
    themeTags: ['hard-preferred'],
    rationaleShort: 'Icing is called when the puck is fired the length of the ice illegally.',
    rationaleLong: 'Teams cannot simply clear the puck all the way down the rink to escape pressure, so icing is called when that full-length clear happens without the allowed exceptions.',
  }),
  q({
    prompt: 'In hockey, what is a penalty kill?',
    options: ['The shorthanded unit trying to survive the other team’s power play', 'A shootout attempt taken by a defenseman', 'A line change that follows an icing call'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'hockey',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    isTrickQuestion: false,
    rationaleShort: 'A penalty kill is the shorthanded effort to prevent a goal.',
    rationaleLong: 'When a team takes a penalty, the players left on the ice try to kill off the power play by defending until the penalty expires or possession changes.',
  }),
  q({
    prompt: 'In hockey, what is a hat trick?',
    options: ['Three goals by one player in the same game', 'Three straight penalty kills by one team', 'A goalie shutout that reaches overtime'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'hockey',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    isTrickQuestion: false,
    rationaleShort: 'A hat trick means one player scores three goals in one game.',
    rationaleLong: 'Hockey celebrates a hat trick when the same skater puts three goals on the board during a single game.',
  }),
  q({
    prompt: 'In soccer standings, what does goal difference compare?',
    options: ['Goals scored minus goals allowed', 'Goals scored only in away matches', 'The difference between first-half and second-half goals'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'soccer',
    promptKind: 'rule',
    ...
    lookupRisk: 'low',
    isTrickQuestion: false,
    rationaleShort: 'Goal difference is goals scored minus goals conceded.',
    rationaleLong: 'League tables often use goal difference as a tiebreaker, calculating it by subtracting the goals a team has allowed from the goals it has scored.',
  }),
  q({
    prompt: 'In soccer knockout play, what is extra time?',
    options: ['Additional periods played after a tied match at the end of regulation', 'The minutes a goalkeeper may hold the ball after a save', 'A replay of the match held on a later date'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'soccer',
    promptKind: 'rule',
    ...
    curveballKind: 'rule-nuance',
    themeTags: ['hard-preferred'],
    rationaleShort: 'Extra time is the added knockout period after a regulation draw.',
    rationaleLong: 'When a knockout match is still tied after normal time, many competitions use extra time before deciding whether penalties are needed.',
  }),
  q({
    prompt: 'In tennis scoring, what does deuce mean?',
    options: ['The game is tied at 40-40', 'The server has not yet won a point', 'The set is tied and headed to a tiebreak'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'tennis',
    promptKind: 'term',
    ...
    curveballKind: 'terminology',
    themeTags: ['hard-preferred'],
    rationaleShort: 'Deuce is the tied score at 40-all.',
    rationaleLong: 'When both players reach 40 in the same game, tennis calls the score deuce and requires one player to win two straight points from there.',
  }),
  q({
    prompt: 'In tennis, what is a tiebreak used for?',
    options: ['Settling a set that reaches a specified tied score', 'Deciding which player serves first in the match', 'Replacing a suspended set after rain delay'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'tennis',
    promptKind: 'rule',
    ...
    lookupRisk: 'low',
    isTrickQuestion: false,
    rationaleShort: 'A tiebreak is used to decide a set that reaches the set’s trigger score.',
    rationaleLong: 'Instead of playing on forever, many tennis sets use a tiebreak game once the score reaches a specified tie, such as 6-6.',
  }),
  q({
    prompt: 'In golf, what is a sudden-death playoff?',
    options: ['A playoff that ends as soon as one golfer wins a hole outright', 'A playoff where only birdies count toward the total', 'A playoff played entirely from the fairway instead of the tee'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'golf',
    promptKind: 'rule',
    ...
    curveballKind: 'rule-nuance',
    themeTags: ['hard-preferred'],
    rationaleShort: 'Sudden death ends the playoff the moment one golfer wins a hole.',
    rationaleLong: 'In a sudden-death golf playoff, tied players continue hole by hole until one of them posts the better score on a hole and the event is over.',
  }),
  q({
    prompt: 'In tennis, what is an ace?',
    options: ['A serve that lands in and is untouched by the receiver', 'A rally won after both players reach deuce', 'A tiebreak point that ends the set'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'tennis',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'An ace is a serve the opponent does not touch.',
    rationaleLong: 'Tennis records an ace when a legal serve lands in and the returner cannot get a racket on it.',
  }),
  q({
    prompt: 'In tennis, what does winning in straight sets mean?',
    options: ['Winning the match without dropping a set', 'Winning every service game at love', 'Reaching a tiebreak in every set'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'tennis',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'Straight sets means the winner did not lose a set.',
    rationaleLong: 'When a player wins a match in straight sets, they take the required number of sets without the opponent claiming one.',
  }),
  q({
    prompt: 'In Olympic swimming, what is a medley relay?',
    options: ['A relay where each swimmer uses a different stroke', 'A relay where every swimmer completes the same sprint distance freestyle', 'A relay made up only of individual medley finalists'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'olympics',
    promptKind: 'event',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'A medley relay uses a different stroke on each leg.',
    rationaleLong: 'Olympic medley relays feature four swimmers, each covering one leg in a different stroke rather than all swimming the same style.',
  }),
  q({
    prompt: 'In a relay race, what is the anchor leg?',
    options: ['The final leg run by the last teammate', 'The opening leg used to establish lane position', 'The exchange zone where the baton must be passed'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'olympics',
    promptKind: 'term',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'The anchor leg is the final leg of the relay.',
    rationaleLong: 'Teams refer to the last runner in a relay as the anchor, because that leg closes the race and often decides the finish.',
  }),
  q({
    prompt: 'In boxing, what is a unanimous decision?',
    options: ['A win where all judges score the fight for the same boxer', 'A result declared when both corners agree to stop the fight', 'A win awarded after one clean knockdown in the final round'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'combat',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'A unanimous decision means every judge had the same winner.',
    rationaleLong: 'Combat sports call it a unanimous decision when all of the official judges score the bout for the same fighter on the cards.',
  }),
  q({
    prompt: 'In boxing, what is a jab?',
    options: ['A quick straight punch thrown with the lead hand', 'A looping punch thrown from below the waist', 'A defensive clinch used to stop the action'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'combat',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'A jab is the quick straight punch from the lead hand.',
    rationaleLong: 'Boxers use the jab to score, manage distance, and set up heavier shots because it comes quickly from the lead side.',
  }),
  q({
    prompt: 'In racing, what is a rolling start?',
    options: ['A start where the field is already moving when racing begins', 'A restart where only the leader may leave pit lane first', 'A lap added after the checkered flag for points-paying fastest time'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'motorsport',
    promptKind: 'term',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'A rolling start begins with the field already in motion.',
    rationaleLong: 'In a rolling start, the cars come to the green flag while moving in formation instead of launching from a dead stop on the grid.',
  }),
  q({
    prompt: 'In tennis, what is a passing shot?',
    options: ['A shot hit past a net-rushing opponent', 'A shot that lands beyond the service line and must be replayed', 'A soft shot played only after a let serve'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'tennis',
    promptKind: 'term',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'A passing shot gets the ball past an opponent at the net.',
    rationaleLong: 'Tennis uses passing shot for the stroke that beats an opponent who has come forward, often zipping the ball by them before they can volley.',
  }),
  q({
    prompt: 'In tennis, what is an overhead smash?',
    options: ['A high ball put away above the head with a forceful swing', 'A serve that clips the net and lands in', 'A return hit immediately after the ball bounces twice'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'tennis',
    promptKind: 'term',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'An overhead smash is the forceful overhead put-away shot.',
    rationaleLong: 'Players use an overhead smash to finish off a lob or floating ball by striking it above the head with a serve-like motion.',
  }),
  q({
    prompt: 'In Olympic swimming, what is a freestyle relay?',
    options: ['A relay where every swimmer uses freestyle', 'A relay where each swimmer must use a different stroke', 'A relay with only two swimmers alternating lengths'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'olympics',
    promptKind: 'event',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'A freestyle relay has every swimmer race using freestyle.',
    rationaleLong: 'Unlike a medley relay, a freestyle relay sends each swimmer into the pool using freestyle on every leg.',
  }),
  q({
    prompt: 'In the Olympics, what is a qualifying heat used to do?',
    options: ['Narrow the field before later rounds or the final', 'Award medals before the official final begins', 'Break ties after the gold-medal match ends level'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'olympics',
    promptKind: 'event',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'A qualifying heat trims the field before later rounds.',
    rationaleLong: 'Many Olympic events use heats as preliminary races that decide which competitors advance to semifinals or finals.',
  }),
  q({
    prompt: 'In boxing, what is a counterpunch?',
    options: ['A punch thrown in immediate response to an opponent’s attack', 'A punch delivered only after the referee starts a count', 'A scoring jab that lands while both fighters are clinched'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'combat',
    promptKind: 'term',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'A counterpunch is thrown right after an opponent commits.',
    rationaleLong: 'Counterpunchers look to exploit openings created by an opponent’s offense, firing back immediately as the attack arrives or finishes.',
  }),
  q({
    prompt: 'In boxing, what does fighting out of the orthodox stance usually mean?',
    options: ['Leading with the left hand and left foot for a right-handed boxer', 'Leading with the right hand and right foot for a left-handed boxer', 'Switching stances every round to confuse the judges'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'combat',
    promptKind: 'term',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'Orthodox usually means the left side leads for a right-handed boxer.',
    rationaleLong: 'The orthodox stance is the standard right-handed setup in boxing, with the left foot and left hand forward and the power hand in back.',
  }),
  q({
    prompt: 'In racing, what is the starting grid?',
    options: ['The arranged set of launch positions before the start', 'The area where teams refuel during a caution', 'The electronic timing board that shows lap leaders'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'motorsport',
    promptKind: 'term',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'The grid is the ordered lineup of starting spots.',
    rationaleLong: 'Motorsport calls the lineup of cars before the green flag the starting grid, with positions determined by qualifying or special rules.',
  }),
  q({
    prompt: 'In motorsport strategy, what is a pit window?',
    options: ['The range of laps when making a stop is considered optimal', 'The opening in the pit wall where officials display the checkered flag', 'The period after qualifying when teams may change any engine part freely'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'motorsport',
    promptKind: 'term',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'A pit window is the best lap range for making a stop.',
    rationaleLong: 'Teams talk about the pit window as the span of laps where stopping makes tactical sense based on tires, fuel, and traffic.',
  }),
  q({
    prompt: 'In sports tournaments, what is a wild card?',
    options: ['An entrant who reaches the field without the standard qualification route', 'The top seed placed automatically into the final', 'A tiebreak round added only when the final ends level'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'general-sports',
    promptKind: 'term',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'A wild card is an entrant admitted outside the usual qualification path.',
    rationaleLong: 'Sports use wild card for teams or players who get into a postseason or tournament without winning the standard automatic route.',
  }),
  q({
    prompt: 'In a tournament, what is a semifinal?',
    options: ['The round immediately before the final', 'The round that narrows the field from sixteen to eight', 'The opening stage that determines the seeded draw'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'general-sports',
    promptKind: 'event',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'A semifinal is the round right before the final.',
    rationaleLong: 'Semifinals decide which two competitors or teams advance into the championship match or final round.',
  }),
  q({
    prompt: 'In motorsport results, what does DNF mean?',
    options: ['Did not finish', 'Driver not found', 'Double no-fault'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'motorsport',
    promptKind: 'term',
    ...
    isTrickQuestion: false,
    themeTags: ['hard-preferred'],
    rationaleShort: 'DNF means did not finish.',
    rationaleLong: 'Race results use DNF when a driver or rider fails to reach the finish, usually because of mechanical trouble, a crash, or another retirement.',
  }),
  q({
    prompt: 'In boxing, what does TKO stand for?',
    options: ['Technical knockout', 'Total kickout', 'Timed key offense'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'combat',
    promptKind: 'term',
    ...
    curveballKind: 'terminology',
    rationaleShort: 'TKO stands for technical knockout.',
    rationaleLong: 'A technical knockout occurs when the referee, doctor, or corner stops the fight even though the fighter has not been counted out in the classic knockout sense.',
  }),
];
...
const CURATED_SPORTS_LAUNCH_REPLACEMENTS: CuratedTriviaSourceQuestion[] = [
  q({
    prompt: 'Which franchise did Nick Foles help lead to its first Super Bowl title?',
    options: ['Philadelphia Eagles', 'Jacksonville Jaguars', 'Minnesota Vikings'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'football',
    promptKind: 'achievement',
    salienceScore: 82,
    lookupRisk: 'low',
    rationaleShort: 'Nick Foles led the Eagles to their first Super Bowl win.',
    rationaleLong: 'Nick Foles stepped in during the 2017 season and helped deliver the Philadelphia Eagles their first Super Bowl championship.',
  }),
  q({
    prompt: 'Which trophy is awarded to the NFC champion?',
    options: ['George Halas Trophy', 'Vince Lombardi Trophy', 'Lamar Hunt Trophy'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'football',
    promptKind: 'achievement',
    salienceScore: 78,
    lookupRisk: 'medium',
    rationaleShort: 'The NFC champion receives the George Halas Trophy.',
    rationaleLong: 'The George Halas Trophy goes to the team that wins the NFC Championship Game and advances to the Super Bowl.',
  }),
  q({
    prompt: 'Which NFL coach won six Super Bowls with the New England Patriots?',
    options: ['Bill Belichick', 'Pete Carroll', 'Mike Tomlin'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'football',
    promptKind: 'person',
    salienceScore: 82,
    lookupRisk: 'low',
    rationaleShort: 'Bill Belichick won six Super Bowls with the Patriots.',
    rationaleLong: 'Belichick coached the New England Patriots to six Super Bowl titles, making him one of the most successful NFL coaches ever.',
  }),
  q({
    prompt: 'Brett Favre won his three straight NFL MVP awards with which team?',
    options: ['Green Bay Packers', 'Atlanta Falcons', 'Minnesota Vikings'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'football',
    promptKind: 'achievement',
    salienceScore: 81,
    lookupRisk: 'low',
    rationaleShort: 'Favre won those MVP awards with the Packers.',
    rationaleLong: 'Brett Favre won three straight NFL MVP awards while starring for the Green Bay Packers in the 1990s.',
  }),
  q({
    prompt: 'Which NBA award goes to the Finals MVP?',
    options: ['Bill Russell NBA Finals MVP Award', 'Larry O Brien Trophy', 'Red Auerbach Trophy'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'achievement',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'The Finals MVP receives the Bill Russell NBA Finals MVP Award.',
    rationaleLong: 'The Bill Russell NBA Finals MVP Award is given to the standout player in the NBA Finals.',
  }),
  q({
    prompt: 'Which franchise won titles with both Kobe Bryant and Shaquille O Neal?',
    options: ['Los Angeles Lakers', 'Miami Heat', 'Orlando Magic'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'achievement',
    salienceScore: 82,
    lookupRisk: 'low',
    rationaleShort: 'Bryant and O Neal won those titles with the Lakers.',
    rationaleLong: 'Kobe Bryant and Shaquille O Neal teamed up on the Los Angeles Lakers for a three-peat at the start of the 2000s.',
  }),
  q({
    prompt: 'Which Hall of Fame guard was the centerpiece of the Bad Boys Pistons?',
    options: ['Isiah Thomas', 'Reggie Miller', 'Clyde Drexler'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'person',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'Isiah Thomas was the lead guard of the Bad Boys Pistons.',
    rationaleLong: 'Isiah Thomas led Detroit’s Bad Boys era and helped the Pistons win back-to-back NBA titles.',
  }),
  q({
    prompt: 'Which player won the 2021 NBA Finals MVP award for Milwaukee?',
    options: ['Giannis Antetokounmpo', 'Khris Middleton', 'Jrue Holiday'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'achievement',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'Giannis won the 2021 Finals MVP award.',
    rationaleLong: 'Giannis Antetokounmpo was the 2021 NBA Finals MVP after leading Milwaukee to the championship.',
  }),
  q({
    prompt: 'Which franchise ended its championship drought in the 2016 World Series?',
    options: ['Chicago Cubs', 'Cleveland Guardians', 'New York Mets'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'event',
    salienceScore: 82,
    lookupRisk: 'low',
    rationaleShort: 'The Cubs ended their drought in the 2016 World Series.',
    rationaleLong: 'Chicago ended its long championship drought by winning the 2016 World Series.',
  }),
  q({
    prompt: 'Which player broke MLB s career home run record in 1974?',
    options: ['Hank Aaron', 'Willie Mays', 'Mickey Mantle'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'achievement',
    salienceScore: 81,
    lookupRisk: 'low',
    rationaleShort: 'Hank Aaron broke the career home run record in 1974.',
    rationaleLong: 'Hank Aaron surpassed Babe Ruth s career home run mark in 1974, one of baseball s most famous records.',
  }),
  q({
    prompt: 'Which ballpark is home to the St. Louis Cardinals?',
    options: ['Busch Stadium', 'Kauffman Stadium', 'Great American Ball Park'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'venue',
    salienceScore: 79,
    lookupRisk: 'low',
    rationaleShort: 'The Cardinals play at Busch Stadium.',
    rationaleLong: 'Busch Stadium is the home ballpark of the St. Louis Cardinals.',
  }),
  q({
    prompt: 'Which pitcher is most associated with the Dodgers of the 1960s?',
    options: ['Sandy Koufax', 'Tom Seaver', 'Bob Gibson'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'baseball',
    promptKind: 'person',
    salienceScore: 79,
    lookupRisk: 'medium',
    rationaleShort: 'Sandy Koufax is most associated with the Dodgers of the 1960s.',
    rationaleLong: 'Koufax anchored the Dodgers in the 1960s and remains one of the defining pitchers of that era.',
  }),
  q({
    prompt: 'Which award goes to the NHL s top rookie?',
    options: ['Calder Memorial Trophy', 'Hart Memorial Trophy', 'Vezina Trophy'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'hockey',
    promptKind: 'achievement',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'The NHL s top rookie wins the Calder Memorial Trophy.',
    rationaleLong: 'The Calder Memorial Trophy is awarded to the NHL rookie judged most proficient in a season.',
  }),
  q({
    prompt: 'Which franchise won the 1994 Stanley Cup with Mark Messier as captain?',
    options: ['New York Rangers', 'Vancouver Canucks', 'Edmonton Oilers'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'hockey',
    promptKind: 'event',
    salienceScore: 79,
    lookupRisk: 'medium',
    rationaleShort: 'The Rangers won the 1994 Stanley Cup with Mark Messier as captain.',
    rationaleLong: 'Mark Messier captained the New York Rangers to their 1994 Stanley Cup title, ending the franchise s long drought.',
  }),
  q({
    prompt: 'Which team did Mario Lemieux lead to Stanley Cups in the early 1990s?',
    options: ['Pittsburgh Penguins', 'Montreal Canadiens', 'Detroit Red Wings'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'hockey',
    promptKind: 'achievement',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'Mario Lemieux led the Penguins to Stanley Cups.',
    rationaleLong: 'Mario Lemieux starred for the Pittsburgh Penguins during their Stanley Cup runs in the early 1990s.',
  }),
  q({
    prompt: 'Which team event pits the United States against Europe in golf?',
    options: ['Ryder Cup', 'Presidents Cup', 'Walker Cup'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'golf',
    promptKind: 'event',
    salienceScore: 81,
    lookupRisk: 'low',
    rationaleShort: 'The Ryder Cup is the U.S. versus Europe team event.',
    rationaleLong: 'The Ryder Cup is golf s famous team match between the United States and Europe.',
  }),
  q({
    prompt: 'Which major tournament is played at St Andrews most regularly?',
    options: ['The Open Championship', 'The Masters', 'The U.S. Open'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'golf',
    promptKind: 'event',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'St Andrews is most associated with The Open Championship.',
    rationaleLong: 'The Old Course at St Andrews is one of the most famous regular venues for The Open Championship.',
  }),
  q({
    prompt: 'Which tennis major is played on clay at Roland-Garros?',
    options: ['French Open', 'Australian Open', 'U.S. Open'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'tennis',
    promptKind: 'event',
    salienceScore: 82,
    lookupRisk: 'low',
    rationaleShort: 'Roland-Garros hosts the French Open.',
    rationaleLong: 'The French Open is the Grand Slam tournament played on clay at Roland-Garros in Paris.',
  }),
  q({
    prompt: 'Which Olympic sport combines cross-country skiing with rifle shooting?',
    options: ['Biathlon', 'Nordic combined', 'Modern pentathlon'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'olympics',
    promptKind: 'sport-id',
    salienceScore: 80,
    lookupRisk: 'medium',
    rationaleShort: 'Biathlon combines skiing with rifle shooting.',
    rationaleLong: 'Biathlon is the winter Olympic event that combines cross-country skiing and rifle shooting.',
  }),
  q({
    prompt: 'Apollo Ohno is most closely associated with which Olympic sport?',
    options: ['Speed skating', 'Snowboarding', 'Skiing'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'olympics',
    promptKind: 'sport-id',
    salienceScore: 82,
    lookupRisk: 'low',
    rationaleShort: 'Apollo Ohno is most associated with speed skating.',
    rationaleLong: 'Apollo Ohno became famous as an Olympic short-track speed skater for the United States.',
  }),
  q({
    prompt: 'Which team upset the Patriots in Super Bowl XLII?',
    options: ['New York Giants', 'Philadelphia Eagles', 'Pittsburgh Steelers'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'football',
    promptKind: 'event',
    salienceScore: 81,
    lookupRisk: 'low',
    rationaleShort: 'The Giants beat the Patriots in Super Bowl XLII.',
    rationaleLong: 'The New York Giants upset New England in Super Bowl XLII, stopping the Patriots from completing a perfect season.',
  }),
  q({
    prompt: 'Which coach led the 1985 Chicago Bears to the Super Bowl title?',
    options: ['Mike Ditka', 'Buddy Ryan', 'Tom Landry'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'football',
    promptKind: 'person',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'Mike Ditka coached the 1985 Bears to the title.',
    rationaleLong: 'Mike Ditka was the head coach of the iconic 1985 Chicago Bears championship team.',
  }),
  q({
    prompt: 'Which franchise drafted Tim Duncan in 1997?',
    options: ['San Antonio Spurs', 'Orlando Magic', 'Boston Celtics'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'achievement',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'Tim Duncan was drafted by the Spurs.',
    rationaleLong: 'The San Antonio Spurs selected Tim Duncan with the first pick of the 1997 NBA draft.',
  }),
  q({
    prompt: 'Which team won the 2004 NBA title with Chauncey Billups as Finals MVP?',
    options: ['Detroit Pistons', 'Indiana Pacers', 'San Antonio Spurs'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'event',
    salienceScore: 79,
    lookupRisk: 'low',
    rationaleShort: 'The Pistons won the 2004 NBA title.',
    rationaleLong: 'Detroit beat the heavily favored Lakers in the 2004 NBA Finals, and Chauncey Billups was named Finals MVP.',
  }),
  q({
    prompt: 'Which franchise did Hakeem Olajuwon lead to titles in the mid-1990s?',
    options: ['Houston Rockets', 'New York Knicks', 'Phoenix Suns'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'basketball',
    promptKind: 'achievement',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'Olajuwon led the Rockets to titles.',
    rationaleLong: 'Hakeem Olajuwon was the centerpiece of the Houston Rockets teams that won back-to-back NBA titles in 1994 and 1995.',
  }),
  q({
    prompt: 'Which franchise won the 2004 World Series to end the Curse of the Bambino?',
    options: ['Boston Red Sox', 'St. Louis Cardinals', 'New York Yankees'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'event',
    salienceScore: 82,
    lookupRisk: 'low',
    rationaleShort: 'The Red Sox ended the Curse of the Bambino in 2004.',
    rationaleLong: 'Boston won the 2004 World Series and ended its long championship drought known as the Curse of the Bambino.',
  }),
  q({
    prompt: 'Which team did Cal Ripken Jr. spend his entire MLB career with?',
    options: ['Baltimore Orioles', 'New York Yankees', 'Boston Red Sox'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'baseball',
    promptKind: 'achievement',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'Cal Ripken Jr. spent his career with the Orioles.',
    rationaleLong: 'Cal Ripken Jr. played his entire major league career with the Baltimore Orioles.',
  }),
  q({
    prompt: 'Which franchise is most associated with the Bash Brothers nickname?',
    options: ['Oakland Athletics', 'New York Mets', 'Chicago White Sox'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'baseball',
    promptKind: 'achievement',
    salienceScore: 78,
    lookupRisk: 'medium',
    rationaleShort: 'The Bash Brothers are most associated with the Oakland Athletics.',
    rationaleLong: 'Jose Canseco and Mark McGwire became famous as the Bash Brothers while starring for the Oakland Athletics.',
  }),
  q({
    prompt: 'Which award goes to the top rookie in each MLB league?',
    options: ['Rookie of the Year Award', 'Cy Young Award', 'Silver Slugger Award'],
    answerIndex: 0,
    difficulty: 3,
    subdomain: 'baseball',
    promptKind: 'achievement',
    ...
    lookupRisk: 'low',
    themeTags: ['hard-preferred'],
    rationaleShort: 'The top rookie wins Rookie of the Year.',
    rationaleLong: 'Major League Baseball gives a Rookie of the Year Award in both leagues to the standout first-year player.',
  }),
  q({
    prompt: 'Which franchise won the Stanley Cup in 2018 behind Alex Ovechkin?',
    options: ['Washington Capitals', 'Vegas Golden Knights', 'Tampa Bay Lightning'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'hockey',
    promptKind: 'event',
    salienceScore: 81,
    lookupRisk: 'low',
    rationaleShort: 'The Capitals won the 2018 Stanley Cup.',
    rationaleLong: 'Washington captured its first Stanley Cup in 2018 with Alex Ovechkin as the franchise star and captain.',
  }),
  q({
    prompt: 'Which goalie backstopped the Canadiens to multiple Stanley Cups in the 1980s?',
    options: ['Patrick Roy', 'Curtis Joseph', 'Henrik Lundqvist'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'hockey',
    promptKind: 'person',
    salienceScore: 79,
    lookupRisk: 'low',
    rationaleShort: 'Patrick Roy backstopped the Canadiens in the 1980s.',
    rationaleLong: 'Patrick Roy starred in goal for Montreal and helped the Canadiens win Stanley Cups late in the 1980s and early in the 1990s.',
  }),
  q({
    prompt: 'Which major golf championship uses the Claret Jug trophy?',
    options: ['The Open Championship', 'The Masters', 'The PGA Championship'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'golf',
    promptKind: 'achievement',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'The Open Championship uses the Claret Jug.',
    rationaleLong: 'The Claret Jug is the famous trophy awarded to the winner of The Open Championship.',
  }),
  q({
    prompt: 'Which tennis major is played at the All England Club?',
    options: ['Wimbledon', 'French Open', 'Australian Open'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'tennis',
    promptKind: 'event',
    salienceScore: 81,
    lookupRisk: 'low',
    rationaleShort: 'Wimbledon is played at the All England Club.',
    rationaleLong: 'The All England Club in London hosts Wimbledon, the oldest and most famous grass-court major.',
  }),
  q({
    prompt: 'Which city hosted the 2012 Summer Olympics?',
    options: ['London', 'Beijing', 'Rio de Janeiro'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'olympics',
    promptKind: 'event',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'London hosted the 2012 Summer Olympics.',
    rationaleLong: 'The 2012 Summer Olympics were held in London, the third time the city hosted the modern Games.',
  }),
  q({
    prompt: 'Nadia Comaneci is most closely associated with which Olympic sport?',
    options: ['Gymnastics', 'Figure skating', 'Diving'],
    answerIndex: 0,
    difficulty: 2,
    subdomain: 'olympics',
    promptKind: 'sport-id',
    salienceScore: 80,
    lookupRisk: 'low',
    rationaleShort: 'Nadia Comaneci is most associated with gymnastics.',
    rationaleLong: 'Nadia Comaneci became famous in Olympic gymnastics, especially after scoring the first perfect 10 in the event.',
  }),
].map((question) => ({
  ...question,
  themeTags: [...(question.themeTags ?? []), 'easy-preferred'],
}));

export const CURATED_SPORTS_AUTHORED_BOOSTERS: CuratedTriviaSourceQuestion[] = [
  ...applySportsHardOnlyTail(
    applySportsCurveballOverrides([
    ...CURATED_SPORTS_CORE,
    ...
    ...CURATED_SPORTS_MAINSTREAM_HARD_DEPTH,
    ...CURATED_SPORTS_MID_DEPTH,
    ...CURATED_SPORTS_DAYBREAK_EXPANSION,
    ...buildGeneralSportsReserve(GENERAL_SPORTS_TERM_CARDS),
    ...CURATED_SPORTS_ROTATION_DEPTH,
    ...CURATED_SPORTS_LATE_PATCHES,
    ...CURATED_SPORTS_LAUNCH_REPLACEMENTS,
    ])
  ),
];
...
const MIX_COUNTRY_CARDS: MixCountryCard[] = [
  { country: 'Argentina', capital: 'Buenos Aires', currency: 'Argentine peso', language: 'Spanish', continent: 'South America' },
  { country: 'Australia', capital: 'Canberra', currency: 'Australian dollar', language: 'English', continent: 'Oceania' },
  { country: 'Austria', capital: 'Vienna', currency: 'Euro', language: 'German', continent: 'Europe' },
  { country: 'Bangladesh', capital: 'Dhaka', currency: 'Taka', language: 'Bengali', continent: 'Asia' },
  { country: 'Belgium', capital: 'Brussels', currency: 'Euro', language: 'Dutch', continent: 'Europe' },
  { country: 'Brazil', capital: 'Brasilia', currency: 'Brazilian real', language: 'Portuguese', continent: 'South America' },
  { country: 'Canada', capital: 'Ottawa', currency: 'Canadian dollar', language: 'English', continent: 'North America' },
  { country: 'Chile', capital: 'Santiago', currency: 'Chilean peso', language: 'Spanish', continent: 'South America' },
  { country: 'China', capital: 'Beijing', currency: 'Yuan', language: 'Mandarin', continent: 'Asia' },
  { country: 'Colombia', capital: 'Bogota', currency: 'Colombian peso', language: 'Spanish', continent: 'South America' },
  { country: 'Czech Republic', capital: 'Prague', currency: 'Czech koruna', language: 'Czech', continent: 'Europe' },
  { country: 'Denmark', capital: 'Copenhagen', currency: 'Danish krone', language: 'Danish', continent: 'Europe' },
  { country: 'Egypt', capital: 'Cairo', currency: 'Egyptian pound', language: 'Arabic', continent: 'Africa' },
  { country: 'Ethiopia', capital: 'Addis Ababa', currency: 'Birr', language: 'Amharic', continent: 'Africa' },
  { country: 'Finland', capital: 'Helsinki', currency: 'Euro', language: 'Finnish', continent: 'Europe' },
  { country: 'France', capital: 'Paris', currency: 'Euro', language: 'French', continent: 'Europe' },
  { country: 'Germany', capital: 'Berlin', currency: 'Euro', language: 'German', continent: 'Europe' },
  { country: 'Ghana', capital: 'Accra', currency: 'Cedi', language: 'English', continent: 'Africa' },
  { country: 'Greece', capital: 'Athens', currency: 'Euro', language: 'Greek', continent: 'Europe' },
  { country: 'Hungary', capital: 'Budapest', currency: 'Forint', language: 'Hungarian', continent: 'Europe' },
  { country: 'Iceland', capital: 'Reykjavik', currency: 'Icelandic krona', language: 'Icelandic', continent: 'Europe' },
  { country: 'India', capital: 'New Delhi', currency: 'Indian rupee', language: 'Hindi', continent: 'Asia' },
  { country: 'Indonesia', capital: 'Jakarta', currency: 'Rupiah', language: 'Indonesian', continent: 'Asia' },
  { country: 'Ireland', capital: 'Dublin', currency: 'Euro', language: 'English', continent: 'Europe' },
  { country: 'Israel', capital: 'Jerusalem', currency: 'Shekel', language: 'Hebrew', continent: 'Asia' },
  { country: 'Italy', capital: 'Rome', currency: 'Euro', language: 'Italian', continent: 'Europe' },
  { country: 'Japan', capital: 'Tokyo', currency: 'Yen', language: 'Japanese', continent: 'Asia' },
  { country: 'Kenya', capital: 'Nairobi', currency: 'Kenyan shilling', language: 'Swahili', continent: 'Africa' },
  { country: 'Malaysia', capital: 'Kuala Lumpur', currency: 'Ringgit', language: 'Malay', continent: 'Asia' },
  { country: 'Mexico', capital: 'Mexico City', currency: 'Mexican peso', language: 'Spanish', continent: 'North America' },
  { country: 'Morocco', capital: 'Rabat', currency: 'Moroccan dirham', language: 'Arabic', continent: 'Africa' },
  { country: 'Nepal', capital: 'Kathmandu', currency: 'Nepalese rupee', language: 'Nepali', continent: 'Asia' },
  { country: 'Netherlands', capital: 'Amsterdam', currency: 'Euro', language: 'Dutch', continent: 'Europe' },
  { country: 'New Zealand', capital: 'Wellington', currency: 'New Zealand dollar', language: 'English', continent: 'Oceania' },
  { country: 'Nigeria', capital: 'Abuja', currency: 'Naira', language: 'English', continent: 'Africa' },
  { country: 'Norway', capital: 'Oslo', currency: 'Norwegian krone', language: 'Norwegian', continent: 'Europe' },
  { country: 'Pakistan', capital: 'Islamabad', currency: 'Pakistani rupee', language: 'Urdu', continent: 'Asia' },
  { country: 'Peru', capital: 'Lima', currency: 'Sol', language: 'Spanish', continent: 'South America' },
  { country: 'Philippines', capital: 'Manila', currency: 'Philippine peso', language: 'Filipino', continent: 'Asia' },
  { country: 'Poland', capital: 'Warsaw', currency: 'Zloty', language: 'Polish', continent: 'Europe' },
  { country: 'Portugal', capital: 'Lisbon', currency: 'Euro', language: 'Portuguese', continent: 'Europe' },
  { country: 'Romania', capital: 'Bucharest', currency: 'Leu', language: 'Romanian', continent: 'Europe' },
  { country: 'Saudi Arabia', capital: 'Riyadh', currency: 'Saudi riyal', language: 'Arabic', continent: 'Asia' },
  { country: 'Singapore', capital: 'Singapore', currency: 'Singapore dollar', language: 'English', continent: 'Asia' },
  { country: 'South Africa', capital: 'Pretoria', currency: 'Rand', language: 'English', continent: 'Africa' },
  { country: 'South Korea', capital: 'Seoul', currency: 'Won', language: 'Korean', continent: 'Asia' },
  { country: 'Spain', capital: 'Madrid', currency: 'Euro', language: 'Spanish', continent: 'Europe' },
  { country: 'Sri Lanka', capital: 'Colombo', currency: 'Sri Lankan rupee', language: 'Sinhala', continent: 'Asia' },
  { country: 'Sweden', capital: 'Stockholm', currency: 'Swedish krona', language: 'Swedish', continent: 'Europe' },
  { country: 'Switzerland', capital: 'Bern', currency: 'Swiss franc', language: 'German', continent: 'Europe' },
  { country: 'Taiwan', capital: 'Taipei', currency: 'New Taiwan dollar', language: 'Mandarin', continent: 'Asia' },
  { country: 'Thailand', capital: 'Bangkok', currency: 'Baht', language: 'Thai', continent: 'Asia' },
  { country: 'Turkey', capital: 'Ankara', currency: 'Turkish lira', language: 'Turkish', continent: 'Asia' },
  { country: 'Ukraine', capital: 'Kyiv', currency: 'Hryvnia', language: 'Ukrainian', continent: 'Europe' },
  { country: 'United Arab Emirates', capital: 'Abu Dhabi', currency: 'Dirham', language: 'Arabic', continent: 'Asia' },
  { country: 'United Kingdom', capital: 'London', currency: 'Pound sterling', language: 'English', continent: 'Europe' },
  { country: 'United States', capital: 'Washington, D.C.', currency: 'U.S. dollar', language: 'English', continent: 'North America' },
  { country: 'Venezuela', capital: 'Caracas', currency: 'Bolivar', language: 'Spanish', continent: 'South America' },
  { country: 'Vietnam', capital: 'Hanoi', currency: 'Dong', language: 'Vietnamese', continent: 'Asia' },
];

const MIX_ELEMENT_CARDS: MixElementCard[] = [
...
function buildMixCountryExpansion(cards: MixCountryCard[]): CuratedTriviaSourceQuestion[] {
  ...
  return cards.flatMap((card, index) => {
    ...
    const capitalDifficulty: TriviaDifficultyTarget = index < 18 ? 1 : index < 40 ? 2 : 3;
    const factDifficulty: TriviaDifficultyTarget = index < 12 ? 2 : 3;
    return [
      q({
        prompt: `What is the capital of ${card.country}?`,
        options: buildOptions(card.capital, [capitalA, capitalB]),
        answerIndex: 0,
        difficulty: capitalDifficulty,
        domain: 'world',
        subdomain: 'geography',
        editorialBucket: 'evergreen',
        lookupRisk: 'low',
        promptKind: 'place',
        salienceScore: index < 18 ? 86 : index < 40 ? 80 : 74,
...
function buildMixElementExpansion(cards: MixElementCard[]): CuratedTriviaSourceQuestion[] {
  const elements = cards.map((card) => card.element);
  const symbols = cards.map((card) => card.symbol);

  return cards.flatMap((card, index) => {
    const [elementA, elementB] = pickPeerValues(elements, card.element, index);
    const [symbolA, symbolB] = pickPeerValues(symbols, card.symbol, index + 1);
    const directDifficulty: TriviaDifficultyTarget = index < 20 ? 1 : index < 42 ? 2 : 3;
    const reverseDifficulty: TriviaDifficultyTarget = index < 18 ? 2 : 3;
    return [
      q({
        prompt: `What is the chemical symbol for ${card.element}?`,
        options: buildOptions(card.symbol, [symbolA, symbolB]),
        answerIndex: 0,
        ...
        lookupRisk: 'low',
        promptKind: 'concept',
        salienceScore: index < 20 ? 84 : index < 42 ? 78 : 72,
        citations: searchCitation(`Reference search: symbol for ${card.element}`, `${card.element} chemical symbol ${card.symbol}`),
      }),
      q({
        prompt: `Which element has the symbol ${card.symbol}?`,
        options: buildOptions(card.element, [elementA, elementB]),
        answerIndex: 0,
        ...
        lookupRisk: 'low',
        promptKind: 'concept',
        salienceScore: index < 18 ? 82 : 74,
        citations: searchCitation(`Reference search: element ${card.symbol}`, `${card.symbol} element ${card.element}`),
      }),
    ];
  });
}

export const CURATED_MIX_GENERATED_EXPANSION: CuratedTriviaSourceQuestion[] = [
  ...buildMixCountryExpansion(MIX_COUNTRY_CARDS),
  ...buildMixElementExpansion(MIX_ELEMENT_CARDS),
];

export const CURATED_MIX_PATCHES: CuratedTriviaSourceQuestion[] = [
  ...MIX_PATCHES,
  ...CURATED_MIX_GENERATED_EXPANSION,
  ...CURATED_MIX_LAUNCH_EXPANSION,
];
