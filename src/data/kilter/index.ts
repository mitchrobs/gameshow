...
export const KILTER_RANKS: readonly Omit<KilterRank, 'percent'>[] = [
  ...
  { tier: 2, name: 'Steady', minPercent: 10 },
  { tier: 3, name: 'Posed', minPercent: 25 },
  { tier: 4, name: 'Composed', minPercent: 45 },
  { tier: 5, name: 'Mastered', minPercent: 65, requiresSweep: true },
] as const;
